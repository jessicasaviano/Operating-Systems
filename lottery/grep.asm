...
printint(int fd, int xx, int base, int sgn)
{
 ...
 555:	0f b6 92 a4 07 00 00 	movzbl 0x7a4(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 622:	ff 24 85 4c 07 00 00 	jmp    *0x74c(,%eax,4)
        printint(fd, *ap, 10, 1);
 ...
 687:	75 15                	jne    69e <printf+0xfa>
          s = "(null)";
 689:	be 42 07 00 00       	mov    $0x742,%esi
