...
printint(int fd, int xx, int base, int sgn)
{
 ...
 54d:	0f b6 92 9c 07 00 00 	movzbl 0x79c(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 61a:	ff 24 85 44 07 00 00 	jmp    *0x744(,%eax,4)
        printint(fd, *ap, 10, 1);
 ...
 67f:	75 15                	jne    696 <printf+0xfa>
          s = "(null)";
 681:	be 3a 07 00 00       	mov    $0x73a,%esi
