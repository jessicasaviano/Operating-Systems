...
getcmd(char *buf, int nbuf)
{
  ...
  printf(2, "$ ");
   ...
   e:	68 64 0f 00 00       	push   $0xf64
  13:	6a 02                	push   $0x2
  15:	e8 9a 0c 00 00       	call   cb4 <printf>
  memset(buf, 0, nbuf);
...
panic(char *s)
{
  ...
  54:	68 01 10 00 00       	push   $0x1001
  59:	6a 02                	push   $0x2
  5b:	e8 54 0c 00 00       	call   cb4 <printf>
  exit();
...
00000084 <runcmd>:
{
  ...
  99:	ff 24 85 1c 10 00 00 	jmp    *0x101c(,%eax,4)
    exit();
  a0:	e8 b2 0a 00 00       	call   b57 <exit>
    panic("runcmd");
  a5:	83 ec 0c             	sub    $0xc,%esp
  a8:	68 6c 0f 00 00       	push   $0xf6c
  ...
  cc:	68 73 0f 00 00       	push   $0xf73
  d1:	6a 02                	push   $0x2
  d3:	e8 dc 0b 00 00       	call   cb4 <printf>
    break;
 ...
 116:	68 83 0f 00 00       	push   $0xf83
 11b:	6a 02                	push   $0x2
 11d:	e8 92 0b 00 00       	call   cb4 <printf>
      exit();
...
execcmd(void)
{
 ...
 235:	e8 a0 0c 00 00       	call   eda <malloc>
...
redircmd(struct cmd *subcmd, char *file, char *efile, int mode, int fd)
{
 ...
 25d:	83 ec 10             	sub    $0x10,%esp
  ...
  cmd = malloc(sizeof(*cmd));
 260:	6a 18                	push   $0x18
 262:	e8 73 0c 00 00       	call   eda <malloc>
...
pipecmd(struct cmd *left, struct cmd *right)
{
 ...
 2a5:	83 ec 10             	sub    $0x10,%esp
  ...
  cmd = malloc(sizeof(*cmd));
 2a8:	6a 0c                	push   $0xc
 2aa:	e8 2b 0c 00 00       	call   eda <malloc>
...
listcmd(struct cmd *left, struct cmd *right)
{
 ...
 2db:	83 ec 10             	sub    $0x10,%esp
  ...
  cmd = malloc(sizeof(*cmd));
 2de:	6a 0c                	push   $0xc
 2e0:	e8 f5 0b 00 00       	call   eda <malloc>
...
backcmd(struct cmd *subcmd)
{
 ...
 311:	83 ec 10             	sub    $0x10,%esp
  ...
  cmd = malloc(sizeof(*cmd));
 314:	6a 08                	push   $0x8
 316:	e8 bf 0b 00 00       	call   eda <malloc>
...
gettoken(char **ps, char *es, char **q, char **eq)
{
 ...
 360:	50                   	push   %eax
 361:	68 c8 10 00 00       	push   $0x10c8
 ...
 3d7:	50                   	push   %eax
 3d8:	68 c8 10 00 00       	push   $0x10c8
 ...
 3ef:	50                   	push   %eax
 3f0:	68 c0 10 00 00       	push   $0x10c0
 ...
 423:	50                   	push   %eax
 424:	68 c8 10 00 00       	push   $0x10c8
...
peek(char **ps, char *es, char *toks)
{
 ...
 464:	50                   	push   %eax
 465:	68 c8 10 00 00       	push   $0x10c8
...
nulterminate(struct cmd *cmd)
{
 ...
 7f4:	ff 24 85 34 10 00 00 	jmp    *0x1034(,%eax,4)
  case EXEC:
...
00000876 <parsecmd>:
{
 ...
 8c9:	50                   	push   %eax
 8ca:	68 f6 0f 00 00       	push   $0xff6
 8cf:	6a 02                	push   $0x2
 8d1:	e8 de 03 00 00       	call   cb4 <printf>
    panic("syntax");
 8d6:	c7 04 24 ba 0f 00 00 	movl   $0xfba,(%esp)
...
000008e2 <main>:
{
 ...
 8f6:	6a 02                	push   $0x2
 8f8:	68 05 10 00 00       	push   $0x1005
 ...
 98d:	68 0d 10 00 00       	push   $0x100d
 992:	6a 02                	push   $0x2
 994:	e8 1b 03 00 00       	call   cb4 <printf>
...
putc(int fd, char c)
{
 ...
 c15:	88 55 f4             	mov    %dl,-0xc(%ebp)
  write(fd, &c, 1);
 c18:	6a 01                	push   $0x1
 c1a:	8d 55 f4             	lea    -0xc(%ebp),%edx
 c1d:	52                   	push   %edx
 c1e:	50                   	push   %eax
 c1f:	e8 53 ff ff ff       	call   b77 <write>
}
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 c3d:	0f 95 c1             	setne  %cl
 c40:	c1 ea 1f             	shr    $0x1f,%edx
 c43:	84 d1                	test   %dl,%cl
 c45:	74 44                	je     c8b <printint+0x62>
    neg = 1;
    x = -xx;
 c47:	f7 d8                	neg    %eax
 c49:	89 c1                	mov    %eax,%ecx
    neg = 1;
 c4b:	c7 45 d4 01 00 00 00 	movl   $0x1,-0x2c(%ebp)
  } else {
    x = xx;
  }

  i = 0;
 c52:	bb 00 00 00 00       	mov    $0x0,%ebx
  do{
    buf[i++] = digits[x % base];
 c57:	89 c8                	mov    %ecx,%eax
 c59:	ba 00 00 00 00       	mov    $0x0,%edx
 c5e:	f7 f6                	div    %esi
 c60:	89 df                	mov    %ebx,%edi
 c62:	83 c3 01             	add    $0x1,%ebx
 c65:	0f b6 92 ac 10 00 00 	movzbl 0x10ac(%edx),%edx
 c6c:	88 54 3d d8          	mov    %dl,-0x28(%ebp,%edi,1)
  }while((x /= base) != 0);
 c70:	89 ca                	mov    %ecx,%edx
 c72:	89 c1                	mov    %eax,%ecx
 c74:	39 d6                	cmp    %edx,%esi
 c76:	76 df                	jbe    c57 <printint+0x2e>
  if(neg)
 c78:	83 7d d4 00          	cmpl   $0x0,-0x2c(%ebp)
 c7c:	74 31                	je     caf <printint+0x86>
    buf[i++] = '-';
 c7e:	c6 44 1d d8 2d       	movb   $0x2d,-0x28(%ebp,%ebx,1)
 c83:	8d 5f 02             	lea    0x2(%edi),%ebx
 c86:	8b 75 d0             	mov    -0x30(%ebp),%esi
 c89:	eb 17                	jmp    ca2 <printint+0x79>
    x = xx;
 c8b:	89 c1                	mov    %eax,%ecx
  neg = 0;
 c8d:	c7 45 d4 00 00 00 00 	movl   $0x0,-0x2c(%ebp)
 c94:	eb bc                	jmp    c52 <printint+0x29>

  while(--i >= 0)
    putc(fd, buf[i]);
 c96:	0f be 54 1d d8       	movsbl -0x28(%ebp,%ebx,1),%edx
 c9b:	89 f0                	mov    %esi,%eax
 c9d:	e8 6d ff ff ff       	call   c0f <putc>
  while(--i >= 0)
 ca2:	83 eb 01             	sub    $0x1,%ebx
 ca5:	79 ef                	jns    c96 <printint+0x6d>
}
 ca7:	83 c4 2c             	add    $0x2c,%esp
 caa:	5b                   	pop    %ebx
 cab:	5e                   	pop    %esi
 cac:	5f                   	pop    %edi
 cad:	5d                   	pop    %ebp
 cae:	c3                   	ret    
 caf:	8b 75 d0             	mov    -0x30(%ebp),%esi
 cb2:	eb ee                	jmp    ca2 <printint+0x79>
...
printf(int fd, const char *fmt, ...)
{
 ...
 ccd:	eb 14                	jmp    ce3 <printf+0x2f>
    ...
    if(state == 0){
      if(c == '%'){
        ...
        putc(fd, c);
 ccf:	89 fa                	mov    %edi,%edx
 cd1:	8b 45 08             	mov    0x8(%ebp),%eax
 cd4:	e8 36 ff ff ff       	call   c0f <putc>
 cd9:	eb 05                	jmp    ce0 <printf+0x2c>
      }
    } else if(state == '%'){
 cdb:	83 fe 25             	cmp    $0x25,%esi
 cde:	74 25                	je     d05 <printf+0x51>
  for(i = 0; fmt[i]; i++){
 ce0:	83 c3 01             	add    $0x1,%ebx
 ce3:	8b 45 0c             	mov    0xc(%ebp),%eax
 ce6:	0f b6 04 18          	movzbl (%eax,%ebx,1),%eax
 cea:	84 c0                	test   %al,%al
 cec:	0f 84 20 01 00 00    	je     e12 <printf+0x15e>
    c = fmt[i] & 0xff;
 cf2:	0f be f8             	movsbl %al,%edi
 cf5:	0f b6 c0             	movzbl %al,%eax
    if(state == 0){
 cf8:	85 f6                	test   %esi,%esi
 cfa:	75 df                	jne    cdb <printf+0x27>
      if(c == '%'){
 cfc:	83 f8 25             	cmp    $0x25,%eax
 cff:	75 ce                	jne    ccf <printf+0x1b>
        state = '%';
 d01:	89 c6                	mov    %eax,%esi
 d03:	eb db                	jmp    ce0 <printf+0x2c>
      if(c == 'd'){
 d05:	83 f8 25             	cmp    $0x25,%eax
 d08:	0f 84 cf 00 00 00    	je     ddd <printf+0x129>
 d0e:	0f 8c dd 00 00 00    	jl     df1 <printf+0x13d>
 d14:	83 f8 78             	cmp    $0x78,%eax
 d17:	0f 8f d4 00 00 00    	jg     df1 <printf+0x13d>
 d1d:	83 f8 63             	cmp    $0x63,%eax
 d20:	0f 8c cb 00 00 00    	jl     df1 <printf+0x13d>
 d26:	83 e8 63             	sub    $0x63,%eax
 d29:	83 f8 15             	cmp    $0x15,%eax
 d2c:	0f 87 bf 00 00 00    	ja     df1 <printf+0x13d>
 d32:	ff 24 85 54 10 00 00 	jmp    *0x1054(,%eax,4)
        printint(fd, *ap, 10, 1);
 ...
 d4b:	e8 d9 fe ff ff       	call   c29 <printint>
        ap++;
 ...
 d72:	e8 b2 fe ff ff       	call   c29 <printint>
        ap++;
 ...
 d85:	e9 56 ff ff ff       	jmp    ce0 <printf+0x2c>
        s = (char*)*ap;
 ...
 d97:	75 15                	jne    dae <printf+0xfa>
          s = "(null)";
 d99:	be 4c 10 00 00       	mov    $0x104c,%esi
 d9e:	eb 0e                	jmp    dae <printf+0xfa>
          putc(fd, *s);
 da0:	0f be d2             	movsbl %dl,%edx
 da3:	8b 45 08             	mov    0x8(%ebp),%eax
 da6:	e8 64 fe ff ff       	call   c0f <putc>
          s++;
 dab:	83 c6 01             	add    $0x1,%esi
        while(*s != 0){
 dae:	0f b6 16             	movzbl (%esi),%edx
 db1:	84 d2                	test   %dl,%dl
 db3:	75 eb                	jne    da0 <printf+0xec>
      state = 0;
 db5:	be 00 00 00 00       	mov    $0x0,%esi
 dba:	e9 21 ff ff ff       	jmp    ce0 <printf+0x2c>
        putc(fd, *ap);
 dbf:	8b 7d e4             	mov    -0x1c(%ebp),%edi
 dc2:	0f be 17             	movsbl (%edi),%edx
 dc5:	8b 45 08             	mov    0x8(%ebp),%eax
 dc8:	e8 42 fe ff ff       	call   c0f <putc>
        ap++;
 dcd:	83 c7 04             	add    $0x4,%edi
 dd0:	89 7d e4             	mov    %edi,-0x1c(%ebp)
      state = 0;
 dd3:	be 00 00 00 00       	mov    $0x0,%esi
 dd8:	e9 03 ff ff ff       	jmp    ce0 <printf+0x2c>
        putc(fd, c);
 ddd:	89 fa                	mov    %edi,%edx
 ddf:	8b 45 08             	mov    0x8(%ebp),%eax
 de2:	e8 28 fe ff ff       	call   c0f <putc>
      state = 0;
 de7:	be 00 00 00 00       	mov    $0x0,%esi
 dec:	e9 ef fe ff ff       	jmp    ce0 <printf+0x2c>
        putc(fd, '%');
 df1:	ba 25 00 00 00       	mov    $0x25,%edx
 df6:	8b 45 08             	mov    0x8(%ebp),%eax
 df9:	e8 11 fe ff ff       	call   c0f <putc>
        putc(fd, c);
 dfe:	89 fa                	mov    %edi,%edx
 e00:	8b 45 08             	mov    0x8(%ebp),%eax
 e03:	e8 07 fe ff ff       	call   c0f <putc>
      state = 0;
 e08:	be 00 00 00 00       	mov    $0x0,%esi
 e0d:	e9 ce fe ff ff       	jmp    ce0 <printf+0x2c>
    }
  }
}
...
free(void *ap)
{
 ...
 e1e:	56                   	push   %esi
 e1f:	53                   	push   %ebx
 e20:	8b 5d 08             	mov    0x8(%ebp),%ebx
  Header *bp, *p;

  bp = (Header*)ap - 1;
 e23:	8d 4b f8             	lea    -0x8(%ebx),%ecx
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
 e26:	a1 a8 11 00 00       	mov    0x11a8,%eax
 e2b:	eb 02                	jmp    e2f <free+0x15>
 e2d:	89 d0                	mov    %edx,%eax
 e2f:	39 c8                	cmp    %ecx,%eax
 e31:	73 04                	jae    e37 <free+0x1d>
 e33:	39 08                	cmp    %ecx,(%eax)
 e35:	77 12                	ja     e49 <free+0x2f>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
 e37:	8b 10                	mov    (%eax),%edx
 e39:	39 c2                	cmp    %eax,%edx
 e3b:	77 f0                	ja     e2d <free+0x13>
 e3d:	39 c8                	cmp    %ecx,%eax
 e3f:	72 08                	jb     e49 <free+0x2f>
 e41:	39 ca                	cmp    %ecx,%edx
 e43:	77 04                	ja     e49 <free+0x2f>
 e45:	89 d0                	mov    %edx,%eax
 e47:	eb e6                	jmp    e2f <free+0x15>
      break;
  if(bp + bp->s.size == p->s.ptr){
 e49:	8b 73 fc             	mov    -0x4(%ebx),%esi
 e4c:	8d 3c f1             	lea    (%ecx,%esi,8),%edi
 e4f:	8b 10                	mov    (%eax),%edx
 e51:	39 d7                	cmp    %edx,%edi
 e53:	74 19                	je     e6e <free+0x54>
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
 e55:	89 53 f8             	mov    %edx,-0x8(%ebx)
  if(p + p->s.size == bp){
 e58:	8b 50 04             	mov    0x4(%eax),%edx
 e5b:	8d 34 d0             	lea    (%eax,%edx,8),%esi
 e5e:	39 ce                	cmp    %ecx,%esi
 e60:	74 1b                	je     e7d <free+0x63>
    p->s.size += bp->s.size;
    p->s.ptr = bp->s.ptr;
  } else
    p->s.ptr = bp;
 e62:	89 08                	mov    %ecx,(%eax)
  freep = p;
 e64:	a3 a8 11 00 00       	mov    %eax,0x11a8
}
 e69:	5b                   	pop    %ebx
 e6a:	5e                   	pop    %esi
 e6b:	5f                   	pop    %edi
 ...
 e6d:	c3                   	ret    
    bp->s.size += p->s.ptr->s.size;
 e6e:	03 72 04             	add    0x4(%edx),%esi
 e71:	89 73 fc             	mov    %esi,-0x4(%ebx)
    bp->s.ptr = p->s.ptr->s.ptr;
 e74:	8b 10                	mov    (%eax),%edx
 e76:	8b 12                	mov    (%edx),%edx
 e78:	89 53 f8             	mov    %edx,-0x8(%ebx)
 e7b:	eb db                	jmp    e58 <free+0x3e>
    p->s.size += bp->s.size;
 e7d:	03 53 fc             	add    -0x4(%ebx),%edx
 e80:	89 50 04             	mov    %edx,0x4(%eax)
    p->s.ptr = bp->s.ptr;
 e83:	8b 53 f8             	mov    -0x8(%ebx),%edx
 e86:	89 10                	mov    %edx,(%eax)
 e88:	eb da                	jmp    e64 <free+0x4a>
...
morecore(uint nu)
{
 ...
 e91:	89 c3                	mov    %eax,%ebx
  char *p;
  Header *hp;

  if(nu < 4096)
 e93:	3d ff 0f 00 00       	cmp    $0xfff,%eax
 e98:	77 05                	ja     e9f <morecore+0x15>
    nu = 4096;
 e9a:	bb 00 10 00 00       	mov    $0x1000,%ebx
  p = sbrk(nu * sizeof(Header));
 e9f:	8d 04 dd 00 00 00 00 	lea    0x0(,%ebx,8),%eax
 ea6:	83 ec 0c             	sub    $0xc,%esp
 ea9:	50                   	push   %eax
 eaa:	e8 30 fd ff ff       	call   bdf <sbrk>
  if(p == (char*)-1)
 eaf:	83 c4 10             	add    $0x10,%esp
 eb2:	83 f8 ff             	cmp    $0xffffffff,%eax
 eb5:	74 1c                	je     ed3 <morecore+0x49>
    return 0;
  hp = (Header*)p;
  hp->s.size = nu;
 eb7:	89 58 04             	mov    %ebx,0x4(%eax)
  free((void*)(hp + 1));
 eba:	83 c0 08             	add    $0x8,%eax
 ebd:	83 ec 0c             	sub    $0xc,%esp
 ec0:	50                   	push   %eax
 ec1:	e8 54 ff ff ff       	call   e1a <free>
  return freep;
 ec6:	a1 a8 11 00 00       	mov    0x11a8,%eax
 ecb:	83 c4 10             	add    $0x10,%esp
}
 ece:	8b 5d fc             	mov    -0x4(%ebp),%ebx
 ed1:	c9                   	leave  
 ed2:	c3                   	ret    
    return 0;
 ed3:	b8 00 00 00 00       	mov    $0x0,%eax
 ed8:	eb f4                	jmp    ece <morecore+0x44>
...
malloc(uint nbytes)
{
 ...
 ee4:	8d 58 07             	lea    0x7(%eax),%ebx
 ee7:	c1 eb 03             	shr    $0x3,%ebx
 eea:	83 c3 01             	add    $0x1,%ebx
  if((prevp = freep) == 0){
 eed:	8b 0d a8 11 00 00    	mov    0x11a8,%ecx
 ef3:	85 c9                	test   %ecx,%ecx
 ef5:	74 04                	je     efb <malloc+0x21>
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 ef7:	8b 01                	mov    (%ecx),%eax
 ef9:	eb 4a                	jmp    f45 <malloc+0x6b>
    base.s.ptr = freep = prevp = &base;
 efb:	c7 05 a8 11 00 00 ac 	movl   $0x11ac,0x11a8
 f02:	11 00 00 
 f05:	c7 05 ac 11 00 00 ac 	movl   $0x11ac,0x11ac
 f0c:	11 00 00 
    base.s.size = 0;
 f0f:	c7 05 b0 11 00 00 00 	movl   $0x0,0x11b0
 f16:	00 00 00 
    base.s.ptr = freep = prevp = &base;
 f19:	b9 ac 11 00 00       	mov    $0x11ac,%ecx
 f1e:	eb d7                	jmp    ef7 <malloc+0x1d>
    if(p->s.size >= nunits){
      if(p->s.size == nunits)
 f20:	74 19                	je     f3b <malloc+0x61>
        prevp->s.ptr = p->s.ptr;
      else {
        p->s.size -= nunits;
 f22:	29 da                	sub    %ebx,%edx
 f24:	89 50 04             	mov    %edx,0x4(%eax)
        p += p->s.size;
 f27:	8d 04 d0             	lea    (%eax,%edx,8),%eax
        p->s.size = nunits;
 f2a:	89 58 04             	mov    %ebx,0x4(%eax)
      }
      freep = prevp;
 f2d:	89 0d a8 11 00 00    	mov    %ecx,0x11a8
      return (void*)(p + 1);
 f33:	83 c0 08             	add    $0x8,%eax
    }
    if(p == freep)
 ...
 f36:	8b 5d fc             	mov    -0x4(%ebp),%ebx
 f39:	c9                   	leave  
 f3a:	c3                   	ret    
        prevp->s.ptr = p->s.ptr;
 f3b:	8b 10                	mov    (%eax),%edx
 f3d:	89 11                	mov    %edx,(%ecx)
 f3f:	eb ec                	jmp    f2d <malloc+0x53>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 f41:	89 c1                	mov    %eax,%ecx
 f43:	8b 00                	mov    (%eax),%eax
    if(p->s.size >= nunits){
 f45:	8b 50 04             	mov    0x4(%eax),%edx
 f48:	39 da                	cmp    %ebx,%edx
 f4a:	73 d4                	jae    f20 <malloc+0x46>
    if(p == freep)
 f4c:	39 05 a8 11 00 00    	cmp    %eax,0x11a8
 f52:	75 ed                	jne    f41 <malloc+0x67>
      if((p = morecore(nunits)) == 0)
 f54:	89 d8                	mov    %ebx,%eax
 f56:	e8 2f ff ff ff       	call   e8a <morecore>
 f5b:	85 c0                	test   %eax,%eax
 f5d:	75 e2                	jne    f41 <malloc+0x67>
 f5f:	eb d5                	jmp    f36 <malloc+0x5c>
