...
fmtname(char *path)
{
  ...
  75:	52                   	push   %edx
  76:	6a 20                	push   $0x20
  78:	05 08 08 00 00       	add    $0x808,%eax
  7d:	50                   	push   %eax
  7e:	e8 c5 02 00 00       	call   348 <memset>
  return buf;
  83:	83 c4 10             	add    $0x10,%esp
  86:	bb 08 08 00 00       	mov    $0x808,%ebx
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 591:	0f b6 92 f4 07 00 00 	movzbl 0x7f4(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 65e:	ff 24 85 9c 07 00 00 	jmp    *0x79c(,%eax,4)
        printint(fd, *ap, 10, 1);
 ...
 6c3:	75 15                	jne    6da <printf+0xfa>
          s = "(null)";
 6c5:	be 92 07 00 00       	mov    $0x792,%esi
