...
main(int argc, char *argv[])
{
  ...
  5d:	ff 36                	push   (%esi)
  5f:	68 57 03 00 00       	push   $0x357
  64:	6a 02                	push   $0x2
  66:	e8 6d 01 00 00       	call   1d8 <printf>
      break;
...
putc(int fd, char c)
{
 ...
 141:	52                   	push   %edx
 142:	50                   	push   %eax
 143:	e8 53 ff ff ff       	call   9b <write>
}
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 161:	0f 95 c1             	setne  %cl
 164:	c1 ea 1f             	shr    $0x1f,%edx
 167:	84 d1                	test   %dl,%cl
 169:	74 44                	je     1af <printint+0x62>
    neg = 1;
    x = -xx;
 16b:	f7 d8                	neg    %eax
 ...
 16f:	c7 45 d4 01 00 00 00 	movl   $0x1,-0x2c(%ebp)
  ...
  i = 0;
 176:	bb 00 00 00 00       	mov    $0x0,%ebx
  do{
    buf[i++] = digits[x % base];
 ...
 189:	0f b6 92 d4 03 00 00 	movzbl 0x3d4(%edx),%edx
 190:	88 54 3d d8          	mov    %dl,-0x28(%ebp,%edi,1)
  }while((x /= base) != 0);
 194:	89 ca                	mov    %ecx,%edx
 196:	89 c1                	mov    %eax,%ecx
 198:	39 d6                	cmp    %edx,%esi
 19a:	76 df                	jbe    17b <printint+0x2e>
  if(neg)
 19c:	83 7d d4 00          	cmpl   $0x0,-0x2c(%ebp)
 1a0:	74 31                	je     1d3 <printint+0x86>
    buf[i++] = '-';
 1a2:	c6 44 1d d8 2d       	movb   $0x2d,-0x28(%ebp,%ebx,1)
 1a7:	8d 5f 02             	lea    0x2(%edi),%ebx
 1aa:	8b 75 d0             	mov    -0x30(%ebp),%esi
 1ad:	eb 17                	jmp    1c6 <printint+0x79>
    x = xx;
 1af:	89 c1                	mov    %eax,%ecx
  neg = 0;
 1b1:	c7 45 d4 00 00 00 00 	movl   $0x0,-0x2c(%ebp)
 1b8:	eb bc                	jmp    176 <printint+0x29>

  while(--i >= 0)
    putc(fd, buf[i]);
 1ba:	0f be 54 1d d8       	movsbl -0x28(%ebp,%ebx,1),%edx
 1bf:	89 f0                	mov    %esi,%eax
 1c1:	e8 6d ff ff ff       	call   133 <putc>
  while(--i >= 0)
 1c6:	83 eb 01             	sub    $0x1,%ebx
 1c9:	79 ef                	jns    1ba <printint+0x6d>
}
 1cb:	83 c4 2c             	add    $0x2c,%esp
 1ce:	5b                   	pop    %ebx
 1cf:	5e                   	pop    %esi
 1d0:	5f                   	pop    %edi
 1d1:	5d                   	pop    %ebp
 1d2:	c3                   	ret    
 1d3:	8b 75 d0             	mov    -0x30(%ebp),%esi
 1d6:	eb ee                	jmp    1c6 <printint+0x79>
...
printf(int fd, const char *fmt, ...)
{
 ...
 1f8:	e8 36 ff ff ff       	call   133 <putc>
 1fd:	eb 05                	jmp    204 <printf+0x2c>
      }
    } else if(state == '%'){
 1ff:	83 fe 25             	cmp    $0x25,%esi
 202:	74 25                	je     229 <printf+0x51>
  for(i = 0; fmt[i]; i++){
 204:	83 c3 01             	add    $0x1,%ebx
 207:	8b 45 0c             	mov    0xc(%ebp),%eax
 20a:	0f b6 04 18          	movzbl (%eax,%ebx,1),%eax
 20e:	84 c0                	test   %al,%al
 210:	0f 84 20 01 00 00    	je     336 <printf+0x15e>
    c = fmt[i] & 0xff;
 216:	0f be f8             	movsbl %al,%edi
 219:	0f b6 c0             	movzbl %al,%eax
    if(state == 0){
 21c:	85 f6                	test   %esi,%esi
 21e:	75 df                	jne    1ff <printf+0x27>
      if(c == '%'){
 220:	83 f8 25             	cmp    $0x25,%eax
 223:	75 ce                	jne    1f3 <printf+0x1b>
        state = '%';
 225:	89 c6                	mov    %eax,%esi
 227:	eb db                	jmp    204 <printf+0x2c>
      if(c == 'd'){
 229:	83 f8 25             	cmp    $0x25,%eax
 22c:	0f 84 cf 00 00 00    	je     301 <printf+0x129>
 232:	0f 8c dd 00 00 00    	jl     315 <printf+0x13d>
 238:	83 f8 78             	cmp    $0x78,%eax
 23b:	0f 8f d4 00 00 00    	jg     315 <printf+0x13d>
 241:	83 f8 63             	cmp    $0x63,%eax
 244:	0f 8c cb 00 00 00    	jl     315 <printf+0x13d>
 24a:	83 e8 63             	sub    $0x63,%eax
 24d:	83 f8 15             	cmp    $0x15,%eax
 250:	0f 87 bf 00 00 00    	ja     315 <printf+0x13d>
 256:	ff 24 85 7c 03 00 00 	jmp    *0x37c(,%eax,4)
        printint(fd, *ap, 10, 1);
 ...
 26f:	e8 d9 fe ff ff       	call   14d <printint>
        ap++;
 ...
 282:	eb 80                	jmp    204 <printf+0x2c>
        printint(fd, *ap, 16, 0);
 284:	8b 7d e4             	mov    -0x1c(%ebp),%edi
 287:	8b 17                	mov    (%edi),%edx
 289:	83 ec 0c             	sub    $0xc,%esp
 28c:	6a 00                	push   $0x0
 28e:	b9 10 00 00 00       	mov    $0x10,%ecx
 293:	8b 45 08             	mov    0x8(%ebp),%eax
 296:	e8 b2 fe ff ff       	call   14d <printint>
        ap++;
 29b:	83 c7 04             	add    $0x4,%edi
 29e:	89 7d e4             	mov    %edi,-0x1c(%ebp)
 2a1:	83 c4 10             	add    $0x10,%esp
      state = 0;
 2a4:	be 00 00 00 00       	mov    $0x0,%esi
 2a9:	e9 56 ff ff ff       	jmp    204 <printf+0x2c>
        s = (char*)*ap;
 2ae:	8b 45 e4             	mov    -0x1c(%ebp),%eax
 2b1:	8b 30                	mov    (%eax),%esi
        ap++;
 2b3:	83 c0 04             	add    $0x4,%eax
 2b6:	89 45 e4             	mov    %eax,-0x1c(%ebp)
        if(s == 0)
 2b9:	85 f6                	test   %esi,%esi
 2bb:	75 15                	jne    2d2 <printf+0xfa>
          s = "(null)";
 2bd:	be 73 03 00 00       	mov    $0x373,%esi
 2c2:	eb 0e                	jmp    2d2 <printf+0xfa>
          putc(fd, *s);
 2c4:	0f be d2             	movsbl %dl,%edx
 2c7:	8b 45 08             	mov    0x8(%ebp),%eax
 2ca:	e8 64 fe ff ff       	call   133 <putc>
          s++;
 2cf:	83 c6 01             	add    $0x1,%esi
        while(*s != 0){
 2d2:	0f b6 16             	movzbl (%esi),%edx
 2d5:	84 d2                	test   %dl,%dl
 2d7:	75 eb                	jne    2c4 <printf+0xec>
      state = 0;
 2d9:	be 00 00 00 00       	mov    $0x0,%esi
 2de:	e9 21 ff ff ff       	jmp    204 <printf+0x2c>
        putc(fd, *ap);
 2e3:	8b 7d e4             	mov    -0x1c(%ebp),%edi
 2e6:	0f be 17             	movsbl (%edi),%edx
 2e9:	8b 45 08             	mov    0x8(%ebp),%eax
 2ec:	e8 42 fe ff ff       	call   133 <putc>
        ap++;
 2f1:	83 c7 04             	add    $0x4,%edi
 2f4:	89 7d e4             	mov    %edi,-0x1c(%ebp)
      state = 0;
 2f7:	be 00 00 00 00       	mov    $0x0,%esi
 2fc:	e9 03 ff ff ff       	jmp    204 <printf+0x2c>
        putc(fd, c);
 301:	89 fa                	mov    %edi,%edx
 303:	8b 45 08             	mov    0x8(%ebp),%eax
 306:	e8 28 fe ff ff       	call   133 <putc>
      state = 0;
 30b:	be 00 00 00 00       	mov    $0x0,%esi
 310:	e9 ef fe ff ff       	jmp    204 <printf+0x2c>
        putc(fd, '%');
 315:	ba 25 00 00 00       	mov    $0x25,%edx
 31a:	8b 45 08             	mov    0x8(%ebp),%eax
 31d:	e8 11 fe ff ff       	call   133 <putc>
        putc(fd, c);
 322:	89 fa                	mov    %edi,%edx
 324:	8b 45 08             	mov    0x8(%ebp),%eax
 327:	e8 07 fe ff ff       	call   133 <putc>
      state = 0;
 32c:	be 00 00 00 00       	mov    $0x0,%esi
 331:	e9 ce fe ff ff       	jmp    204 <printf+0x2c>
    }
  }
}
