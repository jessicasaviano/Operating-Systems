...
000000de <getpagetableentry>:
SYSCALL(getpagetableentry)
  de:	b8 18 00 00 00       	mov    $0x18,%eax
  e3:	cd 40                	int    $0x40
  e5:	c3                   	ret    

000000e6 <isphysicalpagefree>:
SYSCALL(isphysicalpagefree)
  e6:	b8 19 00 00 00       	mov    $0x19,%eax
  eb:	cd 40                	int    $0x40
  ed:	c3                   	ret    

000000ee <dumppagetable>:
SYSCALL(dumppagetable)
  ee:	b8 1a 00 00 00       	mov    $0x1a,%eax
  f3:	cd 40                	int    $0x40
  f5:	c3                   	ret    

000000f6 <shutdown>:
SYSCALL(shutdown)
  f6:	b8 17 00 00 00       	mov    $0x17,%eax
  fb:	cd 40                	int    $0x40
  fd:	c3                   	ret    
