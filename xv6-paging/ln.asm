...
00000119 <getpagetableentry>:
SYSCALL(getpagetableentry)
 119:	b8 18 00 00 00       	mov    $0x18,%eax
 11e:	cd 40                	int    $0x40
 120:	c3                   	ret    

00000121 <isphysicalpagefree>:
SYSCALL(isphysicalpagefree)
 121:	b8 19 00 00 00       	mov    $0x19,%eax
 126:	cd 40                	int    $0x40
 128:	c3                   	ret    

00000129 <dumppagetable>:
SYSCALL(dumppagetable)
 129:	b8 1a 00 00 00       	mov    $0x1a,%eax
 12e:	cd 40                	int    $0x40
 130:	c3                   	ret    

00000131 <shutdown>:
SYSCALL(shutdown)
 131:	b8 17 00 00 00       	mov    $0x17,%eax
 136:	cd 40                	int    $0x40
 138:	c3                   	ret    
