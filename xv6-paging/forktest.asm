...
00000330 <getpagetableentry>:
SYSCALL(getpagetableentry)
 330:	b8 18 00 00 00       	mov    $0x18,%eax
 335:	cd 40                	int    $0x40
 337:	c3                   	ret    

00000338 <isphysicalpagefree>:
SYSCALL(isphysicalpagefree)
 338:	b8 19 00 00 00       	mov    $0x19,%eax
 33d:	cd 40                	int    $0x40
 33f:	c3                   	ret    

00000340 <dumppagetable>:
