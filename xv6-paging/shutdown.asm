...
main(int argc, char *argv[])
{
  ...
  shutdown();
   6:	e8 cd 00 00 00       	call   d8 <shutdown>
  exit();
...
000000c0 <getpagetableentry>:
SYSCALL(getpagetableentry)
  c0:	b8 18 00 00 00       	mov    $0x18,%eax
  c5:	cd 40                	int    $0x40
  c7:	c3                   	ret    

000000c8 <isphysicalpagefree>:
SYSCALL(isphysicalpagefree)
  c8:	b8 19 00 00 00       	mov    $0x19,%eax
  cd:	cd 40                	int    $0x40
  cf:	c3                   	ret    

000000d0 <dumppagetable>:
SYSCALL(dumppagetable)
  d0:	b8 1a 00 00 00       	mov    $0x1a,%eax
  d5:	cd 40                	int    $0x40
  d7:	c3                   	ret    

000000d8 <shutdown>:
SYSCALL(shutdown)
  d8:	b8 17 00 00 00       	mov    $0x17,%eax
  dd:	cd 40                	int    $0x40
  df:	c3                   	ret    
