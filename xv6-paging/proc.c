...
isphysicalpagefree(int ppn){
  //  1. kfree in kalloc.c maintains a linked list of free pages, whose head is stored in kmem.freelist.
   // 2. The linked list nodes are stored in the free pages themselves.
