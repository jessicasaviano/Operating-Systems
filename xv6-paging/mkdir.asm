...
main(int argc, char *argv[])
{
  ...
  45:	c7 44 24 04 4c 03 00 	movl   $0x34c,0x4(%esp)
  4c:	00 
...
00000137 <shutdown>:
SYSCALL(shutdown)
 137:	b8 17 00 00 00       	mov    $0x17,%eax
 13c:	cd 40                	int    $0x40
 13e:	c3                   	ret    
 13f:	90                   	nop
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 19e:	f7 f1                	div    %ecx
 1a0:	0f b6 92 6f 03 00 00 	movzbl 0x36f(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 295:	75 19                	jne    2b0 <printf+0xd4>
          s = "(null)";
 297:	bb 68 03 00 00       	mov    $0x368,%ebx
