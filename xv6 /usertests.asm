...
iputtest(void)
{
  ...
  printf(stdout, "iput test\n");
       ...
       b:	ff 35 3c 53 00 00    	push   0x533c
      11:	e8 66 38 00 00       	call   387c <printf>
  ...
  printf(stdout, "iput test ok\n");
      ...
      6d:	ff 35 3c 53 00 00    	push   0x533c
      73:	e8 04 38 00 00       	call   387c <printf>
}
    ...
    printf(stdout, "mkdir failed\n");
      ...
      85:	ff 35 3c 53 00 00    	push   0x533c
      8b:	e8 ec 37 00 00       	call   387c <printf>
    exit();
      90:	e8 8a 36 00 00       	call   371f <exit>
    printf(stdout, "chdir iputdir failed\n");
      95:	83 ec 08             	sub    $0x8,%esp
      98:	68 3a 3b 00 00       	push   $0x3b3a
      9d:	ff 35 3c 53 00 00    	push   0x533c
      a3:	e8 d4 37 00 00       	call   387c <printf>
    exit();
      a8:	e8 72 36 00 00       	call   371f <exit>
    printf(stdout, "unlink ../iputdir failed\n");
      ad:	83 ec 08             	sub    $0x8,%esp
      b0:	68 5b 3b 00 00       	push   $0x3b5b
      b5:	ff 35 3c 53 00 00    	push   0x533c
      bb:	e8 bc 37 00 00       	call   387c <printf>
    exit();
      c0:	e8 5a 36 00 00       	call   371f <exit>
    printf(stdout, "chdir / failed\n");
      c5:	83 ec 08             	sub    $0x8,%esp
      c8:	68 77 3b 00 00       	push   $0x3b77
      cd:	ff 35 3c 53 00 00    	push   0x533c
      d3:	e8 a4 37 00 00       	call   387c <printf>
    exit();
...
exitiputtest(void)
{
  ...
  printf(stdout, "exitiput test\n");
      ...
      e8:	ff 35 3c 53 00 00    	push   0x533c
      ee:	e8 89 37 00 00       	call   387c <printf>
  ...
  if(pid == 0){
    ...
    printf(stdout, "fork failed\n");
     ...
     14e:	ff 35 3c 53 00 00    	push   0x533c
     154:	e8 23 37 00 00       	call   387c <printf>
    exit();
     159:	e8 c1 35 00 00       	call   371f <exit>
      printf(stdout, "mkdir failed\n");
     15e:	83 ec 08             	sub    $0x8,%esp
     161:	68 2c 3b 00 00       	push   $0x3b2c
     166:	ff 35 3c 53 00 00    	push   0x533c
     16c:	e8 0b 37 00 00       	call   387c <printf>
      exit();
     171:	e8 a9 35 00 00       	call   371f <exit>
      printf(stdout, "child chdir failed\n");
     176:	83 ec 08             	sub    $0x8,%esp
     179:	68 96 3b 00 00       	push   $0x3b96
     17e:	ff 35 3c 53 00 00    	push   0x533c
     184:	e8 f3 36 00 00       	call   387c <printf>
      exit();
     189:	e8 91 35 00 00       	call   371f <exit>
      printf(stdout, "unlink ../iputdir failed\n");
     18e:	83 ec 08             	sub    $0x8,%esp
     191:	68 5b 3b 00 00       	push   $0x3b5b
     196:	ff 35 3c 53 00 00    	push   0x533c
     19c:	e8 db 36 00 00       	call   387c <printf>
      exit();
  ...
  printf(stdout, "exitiput test ok\n");
     ...
     1b3:	ff 35 3c 53 00 00    	push   0x533c
     1b9:	e8 be 36 00 00       	call   387c <printf>
}
...
openiputtest(void)
{
  ...
  printf(stdout, "openiput test\n");
     ...
     1ce:	ff 35 3c 53 00 00    	push   0x533c
     1d4:	e8 a3 36 00 00       	call   387c <printf>
  if(mkdir("oidir") < 0){
  ...
  if(pid == 0){
    ...
    if(fd >= 0){
     ...
     215:	ff 35 3c 53 00 00    	push   0x533c
     21b:	e8 5c 36 00 00       	call   387c <printf>
      exit();
     220:	e8 fa 34 00 00       	call   371f <exit>
    printf(stdout, "mkdir oidir failed\n");
     225:	83 ec 08             	sub    $0x8,%esp
     228:	68 d1 3b 00 00       	push   $0x3bd1
     22d:	ff 35 3c 53 00 00    	push   0x533c
     233:	e8 44 36 00 00       	call   387c <printf>
    exit();
     238:	e8 e2 34 00 00       	call   371f <exit>
    printf(stdout, "fork failed\n");
     23d:	83 ec 08             	sub    $0x8,%esp
     240:	68 6d 4a 00 00       	push   $0x4a6d
     245:	ff 35 3c 53 00 00    	push   0x533c
     24b:	e8 2c 36 00 00       	call   387c <printf>
    exit();
  ...
  printf(stdout, "openiput test ok\n");
     ...
     284:	ff 35 3c 53 00 00    	push   0x533c
     28a:	e8 ed 35 00 00       	call   387c <printf>
}
    ...
    printf(stdout, "unlink failed\n");
     ...
     29c:	ff 35 3c 53 00 00    	push   0x533c
     2a2:	e8 d5 35 00 00       	call   387c <printf>
    exit();
...
opentest(void)
{
  ...
  printf(stdout, "open test\n");
     ...
     2b7:	ff 35 3c 53 00 00    	push   0x533c
     2bd:	e8 ba 35 00 00       	call   387c <printf>
  fd = open("echo", 0);
  ...
  printf(stdout, "open test ok\n");
     ...
     2ff:	ff 35 3c 53 00 00    	push   0x533c
     305:	e8 72 35 00 00       	call   387c <printf>
}
    ...
    printf(stdout, "open echo failed!\n");
     ...
     317:	ff 35 3c 53 00 00    	push   0x533c
     31d:	e8 5a 35 00 00       	call   387c <printf>
    exit();
     322:	e8 f8 33 00 00       	call   371f <exit>
    printf(stdout, "open doesnotexist succeeded!\n");
     327:	83 ec 08             	sub    $0x8,%esp
     32a:	68 36 3c 00 00       	push   $0x3c36
     32f:	ff 35 3c 53 00 00    	push   0x533c
     335:	e8 42 35 00 00       	call   387c <printf>
    exit();
...
writetest(void)
{
  ...
  printf(stdout, "small file test\n");
     ...
     34c:	ff 35 3c 53 00 00    	push   0x533c
     352:	e8 25 35 00 00       	call   387c <printf>
  ...
  if(fd >= 0){
    ...
    printf(stdout, "creat small succeeded; ok\n");
     ...
     37a:	ff 35 3c 53 00 00    	push   0x533c
     380:	e8 f7 34 00 00       	call   387c <printf>
  } else {
  ...
  for(i = 0; i < 100; i++){
    ...
    printf(stdout, "error: creat small failed!\n");
     ...
     3cf:	ff 35 3c 53 00 00    	push   0x533c
     3d5:	e8 a2 34 00 00       	call   387c <printf>
    exit();
     ...
     3e8:	ff 35 3c 53 00 00    	push   0x533c
     3ee:	e8 89 34 00 00       	call   387c <printf>
      exit();
     ...
     401:	ff 35 3c 53 00 00    	push   0x533c
     407:	e8 70 34 00 00       	call   387c <printf>
      exit();
  ...
  printf(stdout, "writes ok\n");
     ...
     419:	ff 35 3c 53 00 00    	push   0x533c
     41f:	e8 58 34 00 00       	call   387c <printf>
  close(fd);
  ...
  if(fd >= 0){
    ...
    printf(stdout, "open small succeeded ok\n");
     ...
     44c:	ff 35 3c 53 00 00    	push   0x533c
     452:	e8 25 34 00 00       	call   387c <printf>
  } else {
  ...
  if(i == 2000){
    ...
    printf(stdout, "read succeeded ok\n");
     ...
     47c:	ff 35 3c 53 00 00    	push   0x533c
     482:	e8 f5 33 00 00       	call   387c <printf>
  } else {
  ...
  printf(stdout, "small file test ok\n");
     ...
     4aa:	ff 35 3c 53 00 00    	push   0x533c
     4b0:	e8 c7 33 00 00       	call   387c <printf>
}
    ...
    printf(stdout, "error: open small failed!\n");
     ...
     4c7:	ff 35 3c 53 00 00    	push   0x533c
     4cd:	e8 aa 33 00 00       	call   387c <printf>
    exit();
     4d2:	e8 48 32 00 00       	call   371f <exit>
    printf(stdout, "read failed\n");
     4d7:	83 ec 08             	sub    $0x8,%esp
     4da:	68 31 40 00 00       	push   $0x4031
     4df:	ff 35 3c 53 00 00    	push   0x533c
     4e5:	e8 92 33 00 00       	call   387c <printf>
    exit();
     4ea:	e8 30 32 00 00       	call   371f <exit>
    printf(stdout, "unlink small failed\n");
     4ef:	83 ec 08             	sub    $0x8,%esp
     4f2:	68 18 3d 00 00       	push   $0x3d18
     4f7:	ff 35 3c 53 00 00    	push   0x533c
     4fd:	e8 7a 33 00 00       	call   387c <printf>
    exit();
...
writetest1(void)
{
  ...
  printf(stdout, "big files test\n");
     ...
     514:	ff 35 3c 53 00 00    	push   0x533c
     51a:	e8 5d 33 00 00       	call   387c <printf>
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    printf(stdout, "error: creat big failed!\n");
     ...
     577:	ff 35 3c 53 00 00    	push   0x533c
     57d:	e8 fa 32 00 00       	call   387c <printf>
    exit();
     ...
     590:	ff 35 3c 53 00 00    	push   0x533c
     596:	e8 e1 32 00 00       	call   387c <printf>
      exit();
  ...
  for(;;){
    ...
    printf(stdout, "error: open big failed!\n");
     ...
     605:	ff 35 3c 53 00 00    	push   0x533c
     60b:	e8 6c 32 00 00       	call   387c <printf>
    exit();
  ...
  printf(stdout, "big files ok\n");
     ...
     641:	ff 35 3c 53 00 00    	push   0x533c
     647:	e8 30 32 00 00       	call   387c <printf>
}
     ...
     65f:	ff 35 3c 53 00 00    	push   0x533c
     665:	e8 12 32 00 00       	call   387c <printf>
        exit();
     ...
     678:	ff 35 3c 53 00 00    	push   0x533c
     67e:	e8 f9 31 00 00       	call   387c <printf>
      exit();
     ...
     68f:	ff 35 3c 53 00 00    	push   0x533c
     695:	e8 e2 31 00 00       	call   387c <printf>
      exit();
     69a:	e8 80 30 00 00       	call   371f <exit>
    printf(stdout, "unlink big failed\n");
     69f:	83 ec 08             	sub    $0x8,%esp
     6a2:	68 cf 3d 00 00       	push   $0x3dcf
     6a7:	ff 35 3c 53 00 00    	push   0x533c
     6ad:	e8 ca 31 00 00       	call   387c <printf>
    exit();
...
createtest(void)
{
  ...
  printf(stdout, "many creates, followed by unlink test\n");
     ...
     6c3:	ff 35 3c 53 00 00    	push   0x533c
     6c9:	e8 ae 31 00 00       	call   387c <printf>
  ...
  printf(stdout, "many creates, followed by unlink; ok\n");
     ...
     750:	ff 35 3c 53 00 00    	push   0x533c
     756:	e8 21 31 00 00       	call   387c <printf>
}
...
void dirtest(void)
{
  ...
  printf(stdout, "mkdir test\n");
     ...
     76e:	ff 35 3c 53 00 00    	push   0x533c
     774:	e8 03 31 00 00       	call   387c <printf>
  ...
  printf(stdout, "mkdir test ok\n");
     ...
     7d0:	ff 35 3c 53 00 00    	push   0x533c
     7d6:	e8 a1 30 00 00       	call   387c <printf>
}
    ...
    printf(stdout, "mkdir failed\n");
     ...
     7e8:	ff 35 3c 53 00 00    	push   0x533c
     7ee:	e8 89 30 00 00       	call   387c <printf>
    exit();
     7f3:	e8 27 2f 00 00       	call   371f <exit>
    printf(stdout, "chdir dir0 failed\n");
     7f8:	83 ec 08             	sub    $0x8,%esp
     7fb:	68 01 3e 00 00       	push   $0x3e01
     800:	ff 35 3c 53 00 00    	push   0x533c
     806:	e8 71 30 00 00       	call   387c <printf>
    exit();
     80b:	e8 0f 2f 00 00       	call   371f <exit>
    printf(stdout, "chdir .. failed\n");
     810:	83 ec 08             	sub    $0x8,%esp
     813:	68 14 3e 00 00       	push   $0x3e14
     818:	ff 35 3c 53 00 00    	push   0x533c
     81e:	e8 59 30 00 00       	call   387c <printf>
    exit();
     823:	e8 f7 2e 00 00       	call   371f <exit>
    printf(stdout, "unlink dir0 failed\n");
     828:	83 ec 08             	sub    $0x8,%esp
     82b:	68 25 3e 00 00       	push   $0x3e25
     830:	ff 35 3c 53 00 00    	push   0x533c
     836:	e8 41 30 00 00       	call   387c <printf>
    exit();
...
exectest(void)
{
  ...
  printf(stdout, "exec test\n");
     ...
     84b:	ff 35 3c 53 00 00    	push   0x533c
     851:	e8 26 30 00 00       	call   387c <printf>
  if(exec("echo", echoargv) < 0){
     856:	83 c4 08             	add    $0x8,%esp
     859:	68 40 53 00 00       	push   $0x5340
    ...
    printf(stdout, "exec echo failed\n");
     ...
     879:	ff 35 3c 53 00 00    	push   0x533c
     87f:	e8 f8 2f 00 00       	call   387c <printf>
    exit();
...
pipe1(void)
{
  ...
  seq = 0;
    ...
    printf(1, "pipe() failed\n");
     ...
     91e:	6a 01                	push   $0x1
     920:	e8 57 2f 00 00       	call   387c <printf>
    exit();
  ...
  seq = 0;
    ...
    for(n = 0; n < 5; n++){
     ...
     984:	6a 01                	push   $0x1
     986:	e8 f1 2e 00 00       	call   387c <printf>
        exit();
    ...
    exit();
     ...
     99d:	6a 01                	push   $0x1
     99f:	e8 d8 2e 00 00       	call   387c <printf>
          return;
  ...
  printf(1, "pipe1 ok\n");
     ...
     9f2:	6a 01                	push   $0x1
     9f4:	e8 83 2e 00 00       	call   387c <printf>
     ...
     a09:	6a 01                	push   $0x1
     a0b:	e8 6c 2e 00 00       	call   387c <printf>
      exit();
    ...
    printf(1, "fork() failed\n");
     ...
     a1d:	6a 01                	push   $0x1
     a1f:	e8 58 2e 00 00       	call   387c <printf>
    exit();
...
preempt(void)
{
  ...
  printf(1, "preempt: ");
     ...
     a37:	6a 01                	push   $0x1
     a39:	e8 3e 2e 00 00       	call   387c <printf>
  pid1 = fork();
  ...
  if(pid3 == 0){
    ...
    for(;;)
     ...
     ab2:	6a 01                	push   $0x1
     ab4:	e8 c3 2d 00 00       	call   387c <printf>
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    printf(1, "preempt read error");
     ...
     aee:	6a 01                	push   $0x1
     af0:	e8 87 2d 00 00       	call   387c <printf>
    return;
  ...
  printf(1, "kill... ");
     ...
     b13:	6a 01                	push   $0x1
     b15:	e8 62 2d 00 00       	call   387c <printf>
  kill(pid1);
  ...
  printf(1, "wait... ");
     ...
     b3a:	6a 01                	push   $0x1
     b3c:	e8 3b 2d 00 00       	call   387c <printf>
  wait();
  ...
  printf(1, "preempt ok\n");
     ...
     b58:	6a 01                	push   $0x1
     b5a:	e8 1d 2d 00 00       	call   387c <printf>
...
exitwait(void)
{
  ...
  for(i = 0; i < 100; i++){
     ...
     b96:	6a 01                	push   $0x1
     b98:	e8 df 2c 00 00       	call   387c <printf>
      return;
  ...
  printf(1, "exitwait ok\n");
     ...
     baf:	6a 01                	push   $0x1
     bb1:	e8 c6 2c 00 00       	call   387c <printf>
        return;
  ...
  printf(1, "exitwait ok\n");
     ...
     bc8:	6a 01                	push   $0x1
     bca:	e8 ad 2c 00 00       	call   387c <printf>
...
mem(void)
{
  ...
  printf(1, "mem test\n");
     ...
     be2:	6a 01                	push   $0x1
     be4:	e8 93 2c 00 00       	call   387c <printf>
  ppid = getpid();
  ...
  if((pid = fork()) == 0){
    ...
    while((m2 = malloc(10001)) != 0){
     ...
     c13:	e8 8a 2e 00 00       	call   3aa2 <malloc>
    ...
    while(m1){
     ...
     c26:	53                   	push   %ebx
     c27:	e8 b6 2d 00 00       	call   39e2 <free>
    ...
    m1 = malloc(1024*20);
     ...
     c3d:	e8 60 2e 00 00       	call   3aa2 <malloc>
    if(m1 == 0){
    ...
    free(m1);
     ...
     c4c:	50                   	push   %eax
     c4d:	e8 90 2d 00 00       	call   39e2 <free>
    printf(1, "mem ok\n");
     c52:	83 c4 08             	add    $0x8,%esp
     c55:	68 50 3f 00 00       	push   $0x3f50
     c5a:	6a 01                	push   $0x1
     c5c:	e8 1b 2c 00 00       	call   387c <printf>
    exit();
     ...
     c6e:	6a 01                	push   $0x1
     c70:	e8 07 2c 00 00       	call   387c <printf>
      kill(ppid);
...
sharedfd(void)
{
  ...
  printf(1, "sharedfd test\n");
     ...
     c9d:	6a 01                	push   $0x1
     c9f:	e8 d8 2b 00 00       	call   387c <printf>
  ...
  for(i = 0; i < 1000; i++){
    ...
    printf(1, "fstests: cannot open sharedfd for writing");
     ...
     d1e:	6a 01                	push   $0x1
     d20:	e8 57 2b 00 00       	call   387c <printf>
    return;
  ...
  memset(buf, pid==0?'c':'p', sizeof(buf));
     ...
     d3c:	6a 01                	push   $0x1
     d3e:	e8 39 2b 00 00       	call   387c <printf>
      break;
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    printf(1, "fstests: cannot open sharedfd for reading\n");
     ...
     da4:	6a 01                	push   $0x1
     da6:	e8 d1 2a 00 00       	call   387c <printf>
    return;
  ...
  if(nc == 10000 && np == 10000){
    ...
    printf(1, "sharedfd ok\n");
     ...
     e07:	6a 01                	push   $0x1
     e09:	e8 6e 2a 00 00       	call   387c <printf>
    ...
    printf(1, "sharedfd oops %d %d\n", nc, np);
     ...
     e20:	6a 01                	push   $0x1
     e22:	e8 55 2a 00 00       	call   387c <printf>
    exit();
...
fourfiles(void)
{
  ...
  printf(1, "fourfiles test\n");
     ...
     e56:	6a 01                	push   $0x1
     e58:	e8 1f 2a 00 00       	call   387c <printf>
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    if(pid < 0){
     ...
     e6f:	6a 01                	push   $0x1
     e71:	e8 06 2a 00 00       	call   387c <printf>
      exit();
    ...
    if(pid == 0){
     ...
     e83:	6a 01                	push   $0x1
     e85:	e8 f2 29 00 00       	call   387c <printf>
        exit();
     ...
     e98:	6a 01                	push   $0x1
     e9a:	e8 dd 29 00 00       	call   387c <printf>
          exit();
  ...
  for(i = 0; i < 2; i++){
    ...
    while((n = read(fd, buf, sizeof(buf))) > 0){
     ...
     f4c:	6a 01                	push   $0x1
     f4e:	e8 29 29 00 00       	call   387c <printf>
          exit();
  ...
  for(i = 0; i < 2; i++){
    ...
    while((n = read(fd, buf, sizeof(buf))) > 0){
     ...
     fec:	6a 01                	push   $0x1
     fee:	e8 89 28 00 00       	call   387c <printf>
      exit();
  ...
  printf(1, "fourfiles ok\n");
    ...
    1000:	6a 01                	push   $0x1
    1002:	e8 75 28 00 00       	call   387c <printf>
}
...
createdelete(void)
{
  ...
  printf(1, "createdelete test\n");
    ...
    101f:	6a 01                	push   $0x1
    1021:	e8 56 28 00 00       	call   387c <printf>
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    1051:	6a 01                	push   $0x1
    1053:	e8 24 28 00 00       	call   387c <printf>
      exit();
    ...
    1071:	6a 01                	push   $0x1
    1073:	e8 04 28 00 00       	call   387c <printf>
          exit();
    ...
    10e2:	6a 01                	push   $0x1
    10e4:	e8 93 27 00 00       	call   387c <printf>
            exit();
  ...
  for(i = 0; i < N; i++){
    ...
    116d:	6a 01                	push   $0x1
    116f:	e8 08 27 00 00       	call   387c <printf>
        exit();
    ...
    1189:	6a 01                	push   $0x1
    118b:	e8 ec 26 00 00       	call   387c <printf>
        exit();
  ...
  printf(1, "createdelete ok\n");
    ...
    11f6:	6a 01                	push   $0x1
    11f8:	e8 7f 26 00 00       	call   387c <printf>
}
...
unlinkread(void)
{
  ...
  printf(1, "unlinkread test\n");
    ...
    1214:	6a 01                	push   $0x1
    1216:	e8 61 26 00 00       	call   387c <printf>
  ...
  printf(1, "unlinkread ok\n");
    ...
    1317:	6a 01                	push   $0x1
    1319:	e8 5e 25 00 00       	call   387c <printf>
}
    ...
    1330:	6a 01                	push   $0x1
    1332:	e8 45 25 00 00       	call   387c <printf>
    exit();
    ...
    1344:	6a 01                	push   $0x1
    1346:	e8 31 25 00 00       	call   387c <printf>
    exit();
    ...
    1358:	6a 01                	push   $0x1
    135a:	e8 1d 25 00 00       	call   387c <printf>
    exit();
    ...
    136c:	6a 01                	push   $0x1
    136e:	e8 09 25 00 00       	call   387c <printf>
    exit();
    ...
    1380:	6a 01                	push   $0x1
    1382:	e8 f5 24 00 00       	call   387c <printf>
    exit();
    ...
    1394:	6a 01                	push   $0x1
    1396:	e8 e1 24 00 00       	call   387c <printf>
    exit();
...
linktest(void)
{
  ...
  printf(1, "linktest\n");
    ...
    13ac:	6a 01                	push   $0x1
    13ae:	e8 c9 24 00 00       	call   387c <printf>
  ...
  printf(1, "linktest ok\n");
    ...
    1503:	6a 01                	push   $0x1
    1505:	e8 72 23 00 00       	call   387c <printf>
}
    ...
    151a:	6a 01                	push   $0x1
    151c:	e8 5b 23 00 00       	call   387c <printf>
    exit();
    ...
    152e:	6a 01                	push   $0x1
    1530:	e8 47 23 00 00       	call   387c <printf>
    exit();
    ...
    1542:	6a 01                	push   $0x1
    1544:	e8 33 23 00 00       	call   387c <printf>
    exit();
    ...
    1556:	6a 01                	push   $0x1
    1558:	e8 1f 23 00 00       	call   387c <printf>
    exit();
    ...
    156a:	6a 01                	push   $0x1
    156c:	e8 0b 23 00 00       	call   387c <printf>
    exit();
    ...
    157e:	6a 01                	push   $0x1
    1580:	e8 f7 22 00 00       	call   387c <printf>
    exit();
    ...
    1592:	6a 01                	push   $0x1
    1594:	e8 e3 22 00 00       	call   387c <printf>
    exit();
    ...
    15a6:	6a 01                	push   $0x1
    15a8:	e8 cf 22 00 00       	call   387c <printf>
    exit();
    ...
    15ba:	6a 01                	push   $0x1
    15bc:	e8 bb 22 00 00       	call   387c <printf>
    exit();
...
concreate(void)
{
  ...
  printf(1, "concreate test\n");
    ...
    15d4:	6a 01                	push   $0x1
    15d6:	e8 a1 22 00 00       	call   387c <printf>
  file[0] = 'C';
  ...
  for(i = 0; i < 40; i++){
    ...
    16d3:	6a 01                	push   $0x1
    16d5:	e8 a2 21 00 00       	call   387c <printf>
        exit();
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    175f:	6a 01                	push   $0x1
    1761:	e8 16 21 00 00       	call   387c <printf>
        exit();
    ...
    1777:	6a 01                	push   $0x1
    1779:	e8 fe 20 00 00       	call   387c <printf>
        exit();
  ...
  for(i = 0; i < 40; i++){
    ...
    17a6:	6a 01                	push   $0x1
    17a8:	e8 cf 20 00 00       	call   387c <printf>
    exit();
    ...
    17ba:	6a 01                	push   $0x1
    17bc:	e8 bb 20 00 00       	call   387c <printf>
      exit();
  ...
  printf(1, "concreate ok\n");
    ...
    18a2:	6a 01                	push   $0x1
    18a4:	e8 d3 1f 00 00       	call   387c <printf>
}
...
linkunlink()
{
  ...
  printf(1, "linkunlink test\n");
    ...
    18c2:	6a 01                	push   $0x1
    18c4:	e8 b3 1f 00 00       	call   387c <printf>
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    18f9:	6a 01                	push   $0x1
    18fb:	e8 7c 1f 00 00       	call   387c <printf>
    exit();
  ...
  printf(1, "linkunlink ok\n");
    ...
    1994:	6a 01                	push   $0x1
    1996:	e8 e1 1e 00 00       	call   387c <printf>
}
...
bigdir(void)
{
  ...
  printf(1, "bigdir test\n");
    ...
    19b4:	6a 01                	push   $0x1
    19b6:	e8 c1 1e 00 00       	call   387c <printf>
  unlink("bd");
  ...
  for(i = 0; i < 500; i++){
    ...
    1a4d:	6a 01                	push   $0x1
    1a4f:	e8 28 1e 00 00       	call   387c <printf>
    exit();
    ...
    1a61:	6a 01                	push   $0x1
    1a63:	e8 14 1e 00 00       	call   387c <printf>
      exit();
  ...
  for(i = 0; i < 500; i++){
    ...
    1ad9:	6a 01                	push   $0x1
    1adb:	e8 9c 1d 00 00       	call   387c <printf>
      exit();
  ...
  printf(1, "bigdir ok\n");
    ...
    1aed:	6a 01                	push   $0x1
    1aef:	e8 88 1d 00 00       	call   387c <printf>
}
...
subdir(void)
{
  ...
  printf(1, "subdir test\n");
    ...
    1b08:	6a 01                	push   $0x1
    1b0a:	e8 6d 1d 00 00       	call   387c <printf>
  ...
  printf(1, "subdir ok\n");
    ...
    1f37:	6a 01                	push   $0x1
    1f39:	e8 3e 19 00 00       	call   387c <printf>
}
    ...
    1f4e:	6a 01                	push   $0x1
    1f50:	e8 27 19 00 00       	call   387c <printf>
    exit();
    ...
    1f62:	6a 01                	push   $0x1
    1f64:	e8 13 19 00 00       	call   387c <printf>
    exit();
    ...
    1f76:	6a 01                	push   $0x1
    1f78:	e8 ff 18 00 00       	call   387c <printf>
    exit();
    ...
    1f8a:	6a 01                	push   $0x1
    1f8c:	e8 eb 18 00 00       	call   387c <printf>
    exit();
    ...
    1f9e:	6a 01                	push   $0x1
    1fa0:	e8 d7 18 00 00       	call   387c <printf>
    exit();
    ...
    1fb2:	6a 01                	push   $0x1
    1fb4:	e8 c3 18 00 00       	call   387c <printf>
    exit();
    ...
    1fc6:	6a 01                	push   $0x1
    1fc8:	e8 af 18 00 00       	call   387c <printf>
    exit();
    ...
    1fda:	6a 01                	push   $0x1
    1fdc:	e8 9b 18 00 00       	call   387c <printf>
    exit();
    ...
    1fee:	6a 01                	push   $0x1
    1ff0:	e8 87 18 00 00       	call   387c <printf>
    exit();
    ...
    2002:	6a 01                	push   $0x1
    2004:	e8 73 18 00 00       	call   387c <printf>
    exit();
    ...
    2016:	6a 01                	push   $0x1
    2018:	e8 5f 18 00 00       	call   387c <printf>
    exit();
    ...
    202a:	6a 01                	push   $0x1
    202c:	e8 4b 18 00 00       	call   387c <printf>
    exit();
    ...
    203e:	6a 01                	push   $0x1
    2040:	e8 37 18 00 00       	call   387c <printf>
    exit();
    ...
    2052:	6a 01                	push   $0x1
    2054:	e8 23 18 00 00       	call   387c <printf>
    exit();
    ...
    2066:	6a 01                	push   $0x1
    2068:	e8 0f 18 00 00       	call   387c <printf>
    exit();
    ...
    207a:	6a 01                	push   $0x1
    207c:	e8 fb 17 00 00       	call   387c <printf>
    exit();
    ...
    208e:	6a 01                	push   $0x1
    2090:	e8 e7 17 00 00       	call   387c <printf>
    exit();
    ...
    20a2:	6a 01                	push   $0x1
    20a4:	e8 d3 17 00 00       	call   387c <printf>
    exit();
    ...
    20b6:	6a 01                	push   $0x1
    20b8:	e8 bf 17 00 00       	call   387c <printf>
    exit();
    ...
    20ca:	6a 01                	push   $0x1
    20cc:	e8 ab 17 00 00       	call   387c <printf>
    exit();
    ...
    20de:	6a 01                	push   $0x1
    20e0:	e8 97 17 00 00       	call   387c <printf>
    exit();
    ...
    20f2:	6a 01                	push   $0x1
    20f4:	e8 83 17 00 00       	call   387c <printf>
    exit();
    ...
    2106:	6a 01                	push   $0x1
    2108:	e8 6f 17 00 00       	call   387c <printf>
    exit();
    ...
    211a:	6a 01                	push   $0x1
    211c:	e8 5b 17 00 00       	call   387c <printf>
    exit();
    ...
    212e:	6a 01                	push   $0x1
    2130:	e8 47 17 00 00       	call   387c <printf>
    exit();
    ...
    2142:	6a 01                	push   $0x1
    2144:	e8 33 17 00 00       	call   387c <printf>
    exit();
    ...
    2156:	6a 01                	push   $0x1
    2158:	e8 1f 17 00 00       	call   387c <printf>
    exit();
    ...
    216a:	6a 01                	push   $0x1
    216c:	e8 0b 17 00 00       	call   387c <printf>
    exit();
    ...
    217e:	6a 01                	push   $0x1
    2180:	e8 f7 16 00 00       	call   387c <printf>
    exit();
    ...
    2192:	6a 01                	push   $0x1
    2194:	e8 e3 16 00 00       	call   387c <printf>
    exit();
    ...
    21a6:	6a 01                	push   $0x1
    21a8:	e8 cf 16 00 00       	call   387c <printf>
    exit();
    ...
    21ba:	6a 01                	push   $0x1
    21bc:	e8 bb 16 00 00       	call   387c <printf>
    exit();
    ...
    21ce:	6a 01                	push   $0x1
    21d0:	e8 a7 16 00 00       	call   387c <printf>
    exit();
    ...
    21e2:	6a 01                	push   $0x1
    21e4:	e8 93 16 00 00       	call   387c <printf>
    exit();
    ...
    21f6:	6a 01                	push   $0x1
    21f8:	e8 7f 16 00 00       	call   387c <printf>
    exit();
    ...
    220a:	6a 01                	push   $0x1
    220c:	e8 6b 16 00 00       	call   387c <printf>
    exit();
    ...
    221e:	6a 01                	push   $0x1
    2220:	e8 57 16 00 00       	call   387c <printf>
    exit();
...
bigwrite(void)
{
  ...
  printf(1, "bigwrite test\n");
    ...
    2238:	6a 01                	push   $0x1
    223a:	e8 3d 16 00 00       	call   387c <printf>
  ...
  for(sz = 499; sz < 12*512; sz += 471){
    ...
    225d:	6a 01                	push   $0x1
    225f:	e8 18 16 00 00       	call   387c <printf>
      exit();
    ...
    2270:	6a 01                	push   $0x1
    2272:	e8 05 16 00 00       	call   387c <printf>
        exit();
  ...
  printf(1, "bigwrite ok\n");
    ...
    22ea:	6a 01                	push   $0x1
    22ec:	e8 8b 15 00 00       	call   387c <printf>
}
...
bigfile(void)
{
  ...
  printf(1, "bigfile test\n");
    ...
    230a:	6a 01                	push   $0x1
    230c:	e8 6b 15 00 00       	call   387c <printf>
  ...
  for(i = 0; i < 20; i++){
    ...
    237f:	6a 01                	push   $0x1
    2381:	e8 f6 14 00 00       	call   387c <printf>
    exit();
    ...
    2393:	6a 01                	push   $0x1
    2395:	e8 e2 14 00 00       	call   387c <printf>
      exit();
  ...
  for(i = 0; ; i++){
    ...
    241b:	6a 01                	push   $0x1
    241d:	e8 5a 14 00 00       	call   387c <printf>
    exit();
    ...
    242f:	6a 01                	push   $0x1
    2431:	e8 46 14 00 00       	call   387c <printf>
      exit();
    ...
    2443:	6a 01                	push   $0x1
    2445:	e8 32 14 00 00       	call   387c <printf>
      exit();
    ...
    2457:	6a 01                	push   $0x1
    2459:	e8 1e 14 00 00       	call   387c <printf>
      exit();
  ...
  printf(1, "bigfile test ok\n");
    ...
    248c:	6a 01                	push   $0x1
    248e:	e8 e9 13 00 00       	call   387c <printf>
}
    ...
    24a6:	6a 01                	push   $0x1
    24a8:	e8 cf 13 00 00       	call   387c <printf>
    exit();
...
fourteen(void)
{
  ...
  printf(1, "fourteen test\n");
    ...
    24bd:	6a 01                	push   $0x1
    24bf:	e8 b8 13 00 00       	call   387c <printf>
  ...
  printf(1, "fourteen ok\n");
    ...
    256b:	6a 01                	push   $0x1
    256d:	e8 0a 13 00 00       	call   387c <printf>
}
    ...
    257f:	6a 01                	push   $0x1
    2581:	e8 f6 12 00 00       	call   387c <printf>
    exit();
    ...
    2593:	6a 01                	push   $0x1
    2595:	e8 e2 12 00 00       	call   387c <printf>
    exit();
    ...
    25a7:	6a 01                	push   $0x1
    25a9:	e8 ce 12 00 00       	call   387c <printf>
    exit();
    ...
    25bb:	6a 01                	push   $0x1
    25bd:	e8 ba 12 00 00       	call   387c <printf>
    exit();
    ...
    25cf:	6a 01                	push   $0x1
    25d1:	e8 a6 12 00 00       	call   387c <printf>
    exit();
    ...
    25e3:	6a 01                	push   $0x1
    25e5:	e8 92 12 00 00       	call   387c <printf>
    exit();
...
rmdot(void)
{
  ...
  printf(1, "rmdot test\n");
    ...
    25fa:	6a 01                	push   $0x1
    25fc:	e8 7b 12 00 00       	call   387c <printf>
  if(mkdir("dots") != 0){
  ...
  printf(1, "rmdot ok\n");
    ...
    26c8:	6a 01                	push   $0x1
    26ca:	e8 ad 11 00 00       	call   387c <printf>
}
    ...
    26dc:	6a 01                	push   $0x1
    26de:	e8 99 11 00 00       	call   387c <printf>
    exit();
    ...
    26f0:	6a 01                	push   $0x1
    26f2:	e8 85 11 00 00       	call   387c <printf>
    exit();
    ...
    2704:	6a 01                	push   $0x1
    2706:	e8 71 11 00 00       	call   387c <printf>
    exit();
    ...
    2718:	6a 01                	push   $0x1
    271a:	e8 5d 11 00 00       	call   387c <printf>
    exit();
    ...
    272c:	6a 01                	push   $0x1
    272e:	e8 49 11 00 00       	call   387c <printf>
    exit();
    ...
    2740:	6a 01                	push   $0x1
    2742:	e8 35 11 00 00       	call   387c <printf>
    exit();
    ...
    2754:	6a 01                	push   $0x1
    2756:	e8 21 11 00 00       	call   387c <printf>
    exit();
    ...
    2768:	6a 01                	push   $0x1
    276a:	e8 0d 11 00 00       	call   387c <printf>
    exit();
...
dirfile(void)
{
  ...
  printf(1, "dir vs file\n");
    ...
    2780:	6a 01                	push   $0x1
    2782:	e8 f5 10 00 00       	call   387c <printf>
  ...
  printf(1, "dir vs file OK\n");
    ...
    28b7:	6a 01                	push   $0x1
    28b9:	e8 be 0f 00 00       	call   387c <printf>
}
    ...
    28ce:	6a 01                	push   $0x1
    28d0:	e8 a7 0f 00 00       	call   387c <printf>
    exit();
    ...
    28e2:	6a 01                	push   $0x1
    28e4:	e8 93 0f 00 00       	call   387c <printf>
    exit();
    ...
    28f6:	6a 01                	push   $0x1
    28f8:	e8 7f 0f 00 00       	call   387c <printf>
    exit();
    ...
    290a:	6a 01                	push   $0x1
    290c:	e8 6b 0f 00 00       	call   387c <printf>
    exit();
    ...
    291e:	6a 01                	push   $0x1
    2920:	e8 57 0f 00 00       	call   387c <printf>
    exit();
    ...
    2932:	6a 01                	push   $0x1
    2934:	e8 43 0f 00 00       	call   387c <printf>
    exit();
    ...
    2946:	6a 01                	push   $0x1
    2948:	e8 2f 0f 00 00       	call   387c <printf>
    exit();
    ...
    295a:	6a 01                	push   $0x1
    295c:	e8 1b 0f 00 00       	call   387c <printf>
    exit();
    ...
    296e:	6a 01                	push   $0x1
    2970:	e8 07 0f 00 00       	call   387c <printf>
    exit();
    ...
    2982:	6a 01                	push   $0x1
    2984:	e8 f3 0e 00 00       	call   387c <printf>
    exit();
...
iref(void)
{
  ...
  printf(1, "empty file name\n");
    ...
    299a:	6a 01                	push   $0x1
    299c:	e8 db 0e 00 00       	call   387c <printf>
  ...
  for(i = 0; i < 50 + 1; i++){
    ...
    29b3:	6a 01                	push   $0x1
    29b5:	e8 c2 0e 00 00       	call   387c <printf>
      exit();
    ...
    29c7:	6a 01                	push   $0x1
    29c9:	e8 ae 0e 00 00       	call   387c <printf>
      exit();
  ...
  printf(1, "empty file name OK\n");
    ...
    2aa7:	6a 01                	push   $0x1
    2aa9:	e8 ce 0d 00 00       	call   387c <printf>
}
...
forktest(void)
{
  ...
  printf(1, "fork test\n");
    ...
    2ac2:	6a 01                	push   $0x1
    2ac4:	e8 b3 0d 00 00       	call   387c <printf>
  ...
  for(; n > 0; n--){
    ...
    2b10:	6a 01                	push   $0x1
    2b12:	e8 65 0d 00 00       	call   387c <printf>
    exit();
    ...
    2b24:	6a 01                	push   $0x1
    2b26:	e8 51 0d 00 00       	call   387c <printf>
      exit();
  ...
  printf(1, "fork test OK\n");
    ...
    2b42:	6a 01                	push   $0x1
    2b44:	e8 33 0d 00 00       	call   387c <printf>
}
    ...
    2b59:	6a 01                	push   $0x1
    2b5b:	e8 1c 0d 00 00       	call   387c <printf>
    exit();
...
sbrktest(void)
{
  ...
  printf(stdout, "sbrk test\n");
    ...
    2b73:	ff 35 3c 53 00 00    	push   0x533c
    2b79:	e8 fe 0c 00 00       	call   387c <printf>
  oldbrk = sbrk(0);
  ...
  for(i = 0; i < 5000; i++){
    ...
    2bd1:	ff 35 3c 53 00 00    	push   0x533c
    2bd7:	e8 a0 0c 00 00       	call   387c <printf>
      exit();
...
#define BIG (100*1024*1024)
  ...
  *lastaddr = 99;
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    2d49:	68 42 49 00 00       	push   $0x4942
    2d4e:	ff 35 3c 53 00 00    	push   0x533c
    2d54:	e8 23 0b 00 00       	call   387c <printf>
    exit();
    2d59:	e8 c1 09 00 00       	call   371f <exit>
    printf(stdout, "sbrk test failed post-fork\n");
    2d5e:	83 ec 08             	sub    $0x8,%esp
    2d61:	68 59 49 00 00       	push   $0x4959
    2d66:	ff 35 3c 53 00 00    	push   0x533c
    2d6c:	e8 0b 0b 00 00       	call   387c <printf>
    exit();
    ...
    2d7e:	68 a0 50 00 00       	push   $0x50a0
    2d83:	ff 35 3c 53 00 00    	push   0x533c
    2d89:	e8 ee 0a 00 00       	call   387c <printf>
    exit();
    2d8e:	e8 8c 09 00 00       	call   371f <exit>
    printf(stdout, "sbrk could not deallocate\n");
    2d93:	83 ec 08             	sub    $0x8,%esp
    2d96:	68 75 49 00 00       	push   $0x4975
    2d9b:	ff 35 3c 53 00 00    	push   0x533c
    2da1:	e8 d6 0a 00 00       	call   387c <printf>
    exit();
    2da6:	e8 74 09 00 00       	call   371f <exit>
    printf(stdout, "sbrk deallocation produced wrong address, a %x c %x\n", a, c);
    2dab:	50                   	push   %eax
    2dac:	53                   	push   %ebx
    2dad:	68 e0 50 00 00       	push   $0x50e0
    2db2:	ff 35 3c 53 00 00    	push   0x533c
    2db8:	e8 bf 0a 00 00       	call   387c <printf>
    exit();
    2dbd:	e8 5d 09 00 00       	call   371f <exit>
    printf(stdout, "sbrk re-allocation failed, a %x c %x\n", a, c);
    2dc2:	56                   	push   %esi
    2dc3:	53                   	push   %ebx
    2dc4:	68 18 51 00 00       	push   $0x5118
    2dc9:	ff 35 3c 53 00 00    	push   0x533c
    2dcf:	e8 a8 0a 00 00       	call   387c <printf>
    exit();
    2dd4:	e8 46 09 00 00       	call   371f <exit>
    printf(stdout, "sbrk de-allocation didn't really deallocate\n");
    2dd9:	83 ec 08             	sub    $0x8,%esp
    2ddc:	68 40 51 00 00       	push   $0x5140
    2de1:	ff 35 3c 53 00 00    	push   0x533c
    2de7:	e8 90 0a 00 00       	call   387c <printf>
    exit();
    2dec:	e8 2e 09 00 00       	call   371f <exit>
    printf(stdout, "sbrk downsize failed, a %x c %x\n", a, c);
    2df1:	50                   	push   %eax
    2df2:	53                   	push   %ebx
    2df3:	68 70 51 00 00       	push   $0x5170
    2df8:	ff 35 3c 53 00 00    	push   0x533c
    2dfe:	e8 79 0a 00 00       	call   387c <printf>
    exit();
    2e03:	e8 17 09 00 00       	call   371f <exit>
      printf(stdout, "fork failed\n");
    2e08:	83 ec 08             	sub    $0x8,%esp
    2e0b:	68 6d 4a 00 00       	push   $0x4a6d
    2e10:	ff 35 3c 53 00 00    	push   0x533c
    2e16:	e8 61 0a 00 00       	call   387c <printf>
      exit();
    ...
    2e23:	50                   	push   %eax
    2e24:	53                   	push   %ebx
    2e25:	68 90 49 00 00       	push   $0x4990
    2e2a:	ff 35 3c 53 00 00    	push   0x533c
    2e30:	e8 47 0a 00 00       	call   387c <printf>
      kill(ppid);
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    ...
    2e5e:	68 65 3e 00 00       	push   $0x3e65
    2e63:	6a 01                	push   $0x1
    2e65:	e8 12 0a 00 00       	call   387c <printf>
    exit();
    ...
    2e8d:	6a 01                	push   $0x1
    2e8f:	68 85 44 00 00       	push   $0x4485
  ...
  printf(stdout, "sbrk test OK\n");
    ...
    2f32:	68 c4 49 00 00       	push   $0x49c4
    2f37:	ff 35 3c 53 00 00    	push   0x533c
    2f3d:	e8 3a 09 00 00       	call   387c <printf>
}
    ...
    2f50:	68 a9 49 00 00       	push   $0x49a9
    2f55:	ff 35 3c 53 00 00    	push   0x533c
    2f5b:	e8 1c 09 00 00       	call   387c <printf>
    exit();
...
validatetest(void)
{
  ...
  printf(stdout, "validate test\n");
    ...
    2f87:	68 d2 49 00 00       	push   $0x49d2
    2f8c:	ff 35 3c 53 00 00    	push   0x533c
    2f92:	e8 e5 08 00 00       	call   387c <printf>
  hi = 1100*1024;
  ...
  for(p = 0; p <= (uint)hi; p += 4096){
    ...
    2fd8:	56                   	push   %esi
    2fd9:	68 e1 49 00 00       	push   $0x49e1
  ...
  for(p = 0; p <= (uint)hi; p += 4096){
    ...
    2ffb:	68 ec 49 00 00       	push   $0x49ec
    3000:	ff 35 3c 53 00 00    	push   0x533c
    3006:	e8 71 08 00 00       	call   387c <printf>
      exit();
  ...
  printf(stdout, "validate ok\n");
    ...
    3013:	68 05 4a 00 00       	push   $0x4a05
    3018:	ff 35 3c 53 00 00    	push   0x533c
    301e:	e8 59 08 00 00       	call   387c <printf>
}
...
bsstest(void)
{
  ...
  printf(stdout, "bss test\n");
    3033:	68 12 4a 00 00       	push   $0x4a12
    3038:	ff 35 3c 53 00 00    	push   0x533c
    303e:	e8 39 08 00 00       	call   387c <printf>
  ...
  for(i = 0; i < sizeof(uninit); i++){
    ...
    3063:	68 1c 4a 00 00       	push   $0x4a1c
    3068:	ff 35 3c 53 00 00    	push   0x533c
    306e:	e8 09 08 00 00       	call   387c <printf>
      exit();
  ...
  printf(stdout, "bss test ok\n");
    ...
    307b:	68 2d 4a 00 00       	push   $0x4a2d
    3080:	ff 35 3c 53 00 00    	push   0x533c
    3086:	e8 f1 07 00 00       	call   387c <printf>
}
...
bigargtest(void)
{
  ...
  unlink("bigarg-ok");
    3096:	68 3a 4a 00 00       	push   $0x4a3a
  ...
  fd = open("bigarg-ok", 0);
    ...
    30ba:	6a 00                	push   $0x0
    30bc:	68 3a 4a 00 00       	push   $0x4a3a
  ...
  unlink("bigarg-ok");
    30da:	c7 04 24 3a 4a 00 00 	movl   $0x4a3a,(%esp)
    ...
    30eb:	c7 04 85 80 9a 00 00 	movl   $0x5194,0x9a80(,%eax,4)
    30f2:	94 51 00 00 
    ...
    310b:	68 44 4a 00 00       	push   $0x4a44
    3110:	ff 35 3c 53 00 00    	push   0x533c
    3116:	e8 61 07 00 00       	call   387c <printf>
    exec("echo", args);
    311b:	83 c4 08             	add    $0x8,%esp
    311e:	68 80 9a 00 00       	push   $0x9a80
    3123:	68 11 3c 00 00       	push   $0x3c11
    3128:	e8 2a 06 00 00       	call   3757 <exec>
    printf(stdout, "bigarg test ok\n");
    312d:	83 c4 08             	add    $0x8,%esp
    3130:	68 51 4a 00 00       	push   $0x4a51
    3135:	ff 35 3c 53 00 00    	push   0x533c
    313b:	e8 3c 07 00 00       	call   387c <printf>
    fd = open("bigarg-ok", O_CREATE);
    3140:	83 c4 08             	add    $0x8,%esp
    3143:	68 00 02 00 00       	push   $0x200
    3148:	68 3a 4a 00 00       	push   $0x4a3a
    ...
    3162:	68 61 4a 00 00       	push   $0x4a61
    3167:	ff 35 3c 53 00 00    	push   0x533c
    316d:	e8 0a 07 00 00       	call   387c <printf>
    exit();
    3172:	e8 a8 05 00 00       	call   371f <exit>
    printf(stdout, "bigarg test failed!\n");
    3177:	83 ec 08             	sub    $0x8,%esp
    317a:	68 7a 4a 00 00       	push   $0x4a7a
    317f:	ff 35 3c 53 00 00    	push   0x533c
    3185:	e8 f2 06 00 00       	call   387c <printf>
    exit();
...
fsfull()
{
  ...
  printf(1, "fsfull test\n");
    3198:	68 8f 4a 00 00       	push   $0x4a8f
    319d:	6a 01                	push   $0x1
    319f:	e8 d8 06 00 00       	call   387c <printf>
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    3235:	56                   	push   %esi
    3236:	68 9c 4a 00 00       	push   $0x4a9c
    323b:	6a 01                	push   $0x1
    323d:	e8 3a 06 00 00       	call   387c <printf>
    ...
    325f:	50                   	push   %eax
    3260:	68 a8 4a 00 00       	push   $0x4aa8
    3265:	6a 01                	push   $0x1
    3267:	e8 10 06 00 00       	call   387c <printf>
      break;
    ...
    329d:	57                   	push   %edi
    329e:	68 b8 4a 00 00       	push   $0x4ab8
    32a3:	6a 01                	push   $0x1
    32a5:	e8 d2 05 00 00       	call   387c <printf>
    close(fd);
  ...
  printf(1, "fsfull test finished\n");
    ...
    3365:	68 c8 4a 00 00       	push   $0x4ac8
    336a:	6a 01                	push   $0x1
    336c:	e8 0b 05 00 00       	call   387c <printf>
}
...
uio()
{
  ...
  printf(1, "uio test\n");
    3382:	68 de 4a 00 00       	push   $0x4ade
    3387:	6a 01                	push   $0x1
    3389:	e8 ee 04 00 00       	call   387c <printf>
  pid = fork();
  ...
  printf(1, "uio test done\n");
    ...
    33a4:	68 e8 4a 00 00       	push   $0x4ae8
    33a9:	6a 01                	push   $0x1
    33ab:	e8 cc 04 00 00       	call   387c <printf>
}
    ...
    33c9:	68 74 52 00 00       	push   $0x5274
    33ce:	6a 01                	push   $0x1
    33d0:	e8 a7 04 00 00       	call   387c <printf>
    exit();
    33d5:	e8 45 03 00 00       	call   371f <exit>
    printf (1, "fork failed\n");
    33da:	83 ec 08             	sub    $0x8,%esp
    33dd:	68 6d 4a 00 00       	push   $0x4a6d
    33e2:	6a 01                	push   $0x1
    33e4:	e8 93 04 00 00       	call   387c <printf>
    exit();
...
void argptest()
{
  ...
  fd = open("init", O_RDONLY);
    33f5:	6a 00                	push   $0x0
    33f7:	68 f7 4a 00 00       	push   $0x4af7
  ...
  printf(1, "arg test passed\n");
    ...
    342e:	68 09 4b 00 00       	push   $0x4b09
    3433:	6a 01                	push   $0x1
    3435:	e8 42 04 00 00       	call   387c <printf>
}
    ...
    3445:	68 fc 4a 00 00       	push   $0x4afc
    344a:	6a 02                	push   $0x2
    344c:	e8 2b 04 00 00       	call   387c <printf>
    exit();
...
rand()
{
  randstate = randstate * 1664525 + 1013904223;
    3456:	69 05 38 53 00 00 0d 	imul   $0x19660d,0x5338,%eax
    345d:	66 19 00 
    3460:	05 5f f3 6e 3c       	add    $0x3c6ef35f,%eax
    3465:	a3 38 53 00 00       	mov    %eax,0x5338
  return randstate;
}
    346a:	c3                   	ret    
...
main(int argc, char *argv[])
{
  ...
  printf(1, "usertests starting\n");
    347c:	68 1a 4b 00 00       	push   $0x4b1a
    3481:	6a 01                	push   $0x1
    3483:	e8 f4 03 00 00       	call   387c <printf>

  if(open("usertests.ran", 0) >= 0){
    3488:	83 c4 08             	add    $0x8,%esp
    348b:	6a 00                	push   $0x0
    348d:	68 2e 4b 00 00       	push   $0x4b2e
    ...
    34a1:	68 98 52 00 00       	push   $0x5298
    34a6:	6a 01                	push   $0x1
    34a8:	e8 cf 03 00 00       	call   387c <printf>
    exit();
  ...
  close(open("usertests.ran", O_CREATE));
    ...
    34ba:	68 2e 4b 00 00       	push   $0x4b2e
...
putc(int fd, char c)
{
    ...
    37da:	83 ec 1c             	sub    $0x1c,%esp
    37dd:	88 55 f4             	mov    %dl,-0xc(%ebp)
  write(fd, &c, 1);
    37e0:	6a 01                	push   $0x1
    37e2:	8d 55 f4             	lea    -0xc(%ebp),%edx
    37e5:	52                   	push   %edx
    37e6:	50                   	push   %eax
    37e7:	e8 53 ff ff ff       	call   373f <write>
}
...
{
    37f1:	55                   	push   %ebp
    37f2:	89 e5                	mov    %esp,%ebp
    37f4:	57                   	push   %edi
    37f5:	56                   	push   %esi
    37f6:	53                   	push   %ebx
    37f7:	83 ec 2c             	sub    $0x2c,%esp
    37fa:	89 45 d0             	mov    %eax,-0x30(%ebp)
    37fd:	89 d0                	mov    %edx,%eax
    37ff:	89 ce                	mov    %ecx,%esi
  char buf[16];
  int i, neg;
  uint x;
  ...
  neg = 0;
  if(sgn && xx < 0){
    3801:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
    3805:	0f 95 c1             	setne  %cl
    3808:	c1 ea 1f             	shr    $0x1f,%edx
    380b:	84 d1                	test   %dl,%cl
    380d:	74 44                	je     3853 <printint+0x62>
    neg = 1;
    x = -xx;
    380f:	f7 d8                	neg    %eax
    3811:	89 c1                	mov    %eax,%ecx
    neg = 1;
    3813:	c7 45 d4 01 00 00 00 	movl   $0x1,-0x2c(%ebp)
  } else {
    x = xx;
  }

  i = 0;
    381a:	bb 00 00 00 00       	mov    $0x0,%ebx
  do{
    buf[i++] = digits[x % base];
    381f:	89 c8                	mov    %ecx,%eax
    3821:	ba 00 00 00 00       	mov    $0x0,%edx
    3826:	f7 f6                	div    %esi
    3828:	89 df                	mov    %ebx,%edi
    382a:	83 c3 01             	add    $0x1,%ebx
    382d:	0f b6 92 24 53 00 00 	movzbl 0x5324(%edx),%edx
    3834:	88 54 3d d8          	mov    %dl,-0x28(%ebp,%edi,1)
  }while((x /= base) != 0);
    3838:	89 ca                	mov    %ecx,%edx
    383a:	89 c1                	mov    %eax,%ecx
    383c:	39 d6                	cmp    %edx,%esi
    383e:	76 df                	jbe    381f <printint+0x2e>
  if(neg)
    3840:	83 7d d4 00          	cmpl   $0x0,-0x2c(%ebp)
    3844:	74 31                	je     3877 <printint+0x86>
    buf[i++] = '-';
    3846:	c6 44 1d d8 2d       	movb   $0x2d,-0x28(%ebp,%ebx,1)
    384b:	8d 5f 02             	lea    0x2(%edi),%ebx
    384e:	8b 75 d0             	mov    -0x30(%ebp),%esi
    3851:	eb 17                	jmp    386a <printint+0x79>
    x = xx;
    3853:	89 c1                	mov    %eax,%ecx
  neg = 0;
    3855:	c7 45 d4 00 00 00 00 	movl   $0x0,-0x2c(%ebp)
    385c:	eb bc                	jmp    381a <printint+0x29>

  while(--i >= 0)
    putc(fd, buf[i]);
    385e:	0f be 54 1d d8       	movsbl -0x28(%ebp,%ebx,1),%edx
    3863:	89 f0                	mov    %esi,%eax
    3865:	e8 6d ff ff ff       	call   37d7 <putc>
  while(--i >= 0)
    386a:	83 eb 01             	sub    $0x1,%ebx
    386d:	79 ef                	jns    385e <printint+0x6d>
}
    386f:	83 c4 2c             	add    $0x2c,%esp
    3872:	5b                   	pop    %ebx
    3873:	5e                   	pop    %esi
    3874:	5f                   	pop    %edi
    3875:	5d                   	pop    %ebp
    3876:	c3                   	ret    
    3877:	8b 75 d0             	mov    -0x30(%ebp),%esi
    387a:	eb ee                	jmp    386a <printint+0x79>
...
{
    387c:	55                   	push   %ebp
    387d:	89 e5                	mov    %esp,%ebp
    387f:	57                   	push   %edi
    3880:	56                   	push   %esi
    3881:	53                   	push   %ebx
    3882:	83 ec 1c             	sub    $0x1c,%esp
  char *s;
  int c, i, state;
  uint *ap;
  ...
  state = 0;
  ap = (uint*)(void*)&fmt + 1;
    3885:	8d 45 10             	lea    0x10(%ebp),%eax
    3888:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  state = 0;
    388b:	be 00 00 00 00       	mov    $0x0,%esi
  for(i = 0; fmt[i]; i++){
    3890:	bb 00 00 00 00       	mov    $0x0,%ebx
    3895:	eb 14                	jmp    38ab <printf+0x2f>
    c = fmt[i] & 0xff;
    if(state == 0){
      if(c == '%'){
        state = '%';
        ...
        putc(fd, c);
    3897:	89 fa                	mov    %edi,%edx
    3899:	8b 45 08             	mov    0x8(%ebp),%eax
    389c:	e8 36 ff ff ff       	call   37d7 <putc>
    38a1:	eb 05                	jmp    38a8 <printf+0x2c>
      }
    } else if(state == '%'){
    38a3:	83 fe 25             	cmp    $0x25,%esi
    38a6:	74 25                	je     38cd <printf+0x51>
  for(i = 0; fmt[i]; i++){
    38a8:	83 c3 01             	add    $0x1,%ebx
    38ab:	8b 45 0c             	mov    0xc(%ebp),%eax
    38ae:	0f b6 04 18          	movzbl (%eax,%ebx,1),%eax
    38b2:	84 c0                	test   %al,%al
    38b4:	0f 84 20 01 00 00    	je     39da <printf+0x15e>
    c = fmt[i] & 0xff;
    38ba:	0f be f8             	movsbl %al,%edi
    38bd:	0f b6 c0             	movzbl %al,%eax
    if(state == 0){
    38c0:	85 f6                	test   %esi,%esi
    38c2:	75 df                	jne    38a3 <printf+0x27>
      if(c == '%'){
    38c4:	83 f8 25             	cmp    $0x25,%eax
    38c7:	75 ce                	jne    3897 <printf+0x1b>
        state = '%';
    38c9:	89 c6                	mov    %eax,%esi
    38cb:	eb db                	jmp    38a8 <printf+0x2c>
      if(c == 'd'){
    38cd:	83 f8 25             	cmp    $0x25,%eax
    38d0:	0f 84 cf 00 00 00    	je     39a5 <printf+0x129>
    38d6:	0f 8c dd 00 00 00    	jl     39b9 <printf+0x13d>
    38dc:	83 f8 78             	cmp    $0x78,%eax
    38df:	0f 8f d4 00 00 00    	jg     39b9 <printf+0x13d>
    38e5:	83 f8 63             	cmp    $0x63,%eax
    38e8:	0f 8c cb 00 00 00    	jl     39b9 <printf+0x13d>
    38ee:	83 e8 63             	sub    $0x63,%eax
    38f1:	83 f8 15             	cmp    $0x15,%eax
    38f4:	0f 87 bf 00 00 00    	ja     39b9 <printf+0x13d>
    38fa:	ff 24 85 cc 52 00 00 	jmp    *0x52cc(,%eax,4)
        printint(fd, *ap, 10, 1);
    ...
    3913:	e8 d9 fe ff ff       	call   37f1 <printint>
        ap++;
    ...
    3926:	eb 80                	jmp    38a8 <printf+0x2c>
        printint(fd, *ap, 16, 0);
    3928:	8b 7d e4             	mov    -0x1c(%ebp),%edi
    392b:	8b 17                	mov    (%edi),%edx
    392d:	83 ec 0c             	sub    $0xc,%esp
    3930:	6a 00                	push   $0x0
    3932:	b9 10 00 00 00       	mov    $0x10,%ecx
    3937:	8b 45 08             	mov    0x8(%ebp),%eax
    393a:	e8 b2 fe ff ff       	call   37f1 <printint>
        ap++;
    393f:	83 c7 04             	add    $0x4,%edi
    3942:	89 7d e4             	mov    %edi,-0x1c(%ebp)
    3945:	83 c4 10             	add    $0x10,%esp
      state = 0;
    3948:	be 00 00 00 00       	mov    $0x0,%esi
    394d:	e9 56 ff ff ff       	jmp    38a8 <printf+0x2c>
        s = (char*)*ap;
    3952:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    3955:	8b 30                	mov    (%eax),%esi
        ap++;
    3957:	83 c0 04             	add    $0x4,%eax
    395a:	89 45 e4             	mov    %eax,-0x1c(%ebp)
        if(s == 0)
    395d:	85 f6                	test   %esi,%esi
    395f:	75 15                	jne    3976 <printf+0xfa>
          s = "(null)";
    3961:	be c2 52 00 00       	mov    $0x52c2,%esi
    3966:	eb 0e                	jmp    3976 <printf+0xfa>
          putc(fd, *s);
    3968:	0f be d2             	movsbl %dl,%edx
    396b:	8b 45 08             	mov    0x8(%ebp),%eax
    396e:	e8 64 fe ff ff       	call   37d7 <putc>
          s++;
    3973:	83 c6 01             	add    $0x1,%esi
        while(*s != 0){
    3976:	0f b6 16             	movzbl (%esi),%edx
    3979:	84 d2                	test   %dl,%dl
    397b:	75 eb                	jne    3968 <printf+0xec>
      state = 0;
    397d:	be 00 00 00 00       	mov    $0x0,%esi
    3982:	e9 21 ff ff ff       	jmp    38a8 <printf+0x2c>
        putc(fd, *ap);
    3987:	8b 7d e4             	mov    -0x1c(%ebp),%edi
    398a:	0f be 17             	movsbl (%edi),%edx
    398d:	8b 45 08             	mov    0x8(%ebp),%eax
    3990:	e8 42 fe ff ff       	call   37d7 <putc>
        ap++;
    3995:	83 c7 04             	add    $0x4,%edi
    3998:	89 7d e4             	mov    %edi,-0x1c(%ebp)
      state = 0;
    399b:	be 00 00 00 00       	mov    $0x0,%esi
    39a0:	e9 03 ff ff ff       	jmp    38a8 <printf+0x2c>
        putc(fd, c);
    39a5:	89 fa                	mov    %edi,%edx
    39a7:	8b 45 08             	mov    0x8(%ebp),%eax
    39aa:	e8 28 fe ff ff       	call   37d7 <putc>
      state = 0;
    39af:	be 00 00 00 00       	mov    $0x0,%esi
    39b4:	e9 ef fe ff ff       	jmp    38a8 <printf+0x2c>
        putc(fd, '%');
    39b9:	ba 25 00 00 00       	mov    $0x25,%edx
    39be:	8b 45 08             	mov    0x8(%ebp),%eax
    39c1:	e8 11 fe ff ff       	call   37d7 <putc>
        putc(fd, c);
    39c6:	89 fa                	mov    %edi,%edx
    39c8:	8b 45 08             	mov    0x8(%ebp),%eax
    39cb:	e8 07 fe ff ff       	call   37d7 <putc>
      state = 0;
    39d0:	be 00 00 00 00       	mov    $0x0,%esi
    39d5:	e9 ce fe ff ff       	jmp    38a8 <printf+0x2c>
    }
  }
}
...
free(void *ap)
{
    ...
    39e6:	56                   	push   %esi
    39e7:	53                   	push   %ebx
    39e8:	8b 5d 08             	mov    0x8(%ebp),%ebx
  Header *bp, *p;

  bp = (Header*)ap - 1;
    39eb:	8d 4b f8             	lea    -0x8(%ebx),%ecx
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    39ee:	a1 00 9b 00 00       	mov    0x9b00,%eax
    39f3:	eb 02                	jmp    39f7 <free+0x15>
    39f5:	89 d0                	mov    %edx,%eax
    39f7:	39 c8                	cmp    %ecx,%eax
    39f9:	73 04                	jae    39ff <free+0x1d>
    39fb:	39 08                	cmp    %ecx,(%eax)
    39fd:	77 12                	ja     3a11 <free+0x2f>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    39ff:	8b 10                	mov    (%eax),%edx
    3a01:	39 c2                	cmp    %eax,%edx
    3a03:	77 f0                	ja     39f5 <free+0x13>
    3a05:	39 c8                	cmp    %ecx,%eax
    3a07:	72 08                	jb     3a11 <free+0x2f>
    3a09:	39 ca                	cmp    %ecx,%edx
    3a0b:	77 04                	ja     3a11 <free+0x2f>
    3a0d:	89 d0                	mov    %edx,%eax
    3a0f:	eb e6                	jmp    39f7 <free+0x15>
      break;
  if(bp + bp->s.size == p->s.ptr){
    3a11:	8b 73 fc             	mov    -0x4(%ebx),%esi
    3a14:	8d 3c f1             	lea    (%ecx,%esi,8),%edi
    3a17:	8b 10                	mov    (%eax),%edx
    3a19:	39 d7                	cmp    %edx,%edi
    3a1b:	74 19                	je     3a36 <free+0x54>
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
    3a1d:	89 53 f8             	mov    %edx,-0x8(%ebx)
  if(p + p->s.size == bp){
    3a20:	8b 50 04             	mov    0x4(%eax),%edx
    3a23:	8d 34 d0             	lea    (%eax,%edx,8),%esi
    3a26:	39 ce                	cmp    %ecx,%esi
    3a28:	74 1b                	je     3a45 <free+0x63>
    p->s.size += bp->s.size;
    p->s.ptr = bp->s.ptr;
  } else
    p->s.ptr = bp;
    3a2a:	89 08                	mov    %ecx,(%eax)
  freep = p;
    3a2c:	a3 00 9b 00 00       	mov    %eax,0x9b00
}
    3a31:	5b                   	pop    %ebx
    3a32:	5e                   	pop    %esi
    3a33:	5f                   	pop    %edi
    ...
    3a35:	c3                   	ret    
    bp->s.size += p->s.ptr->s.size;
    3a36:	03 72 04             	add    0x4(%edx),%esi
    3a39:	89 73 fc             	mov    %esi,-0x4(%ebx)
    bp->s.ptr = p->s.ptr->s.ptr;
    3a3c:	8b 10                	mov    (%eax),%edx
    3a3e:	8b 12                	mov    (%edx),%edx
    3a40:	89 53 f8             	mov    %edx,-0x8(%ebx)
    3a43:	eb db                	jmp    3a20 <free+0x3e>
    p->s.size += bp->s.size;
    3a45:	03 53 fc             	add    -0x4(%ebx),%edx
    3a48:	89 50 04             	mov    %edx,0x4(%eax)
    p->s.ptr = bp->s.ptr;
    3a4b:	8b 53 f8             	mov    -0x8(%ebx),%edx
    3a4e:	89 10                	mov    %edx,(%eax)
    3a50:	eb da                	jmp    3a2c <free+0x4a>
...
morecore(uint nu)
{
    ...
    3a59:	89 c3                	mov    %eax,%ebx
  char *p;
  Header *hp;

  if(nu < 4096)
    3a5b:	3d ff 0f 00 00       	cmp    $0xfff,%eax
    3a60:	77 05                	ja     3a67 <morecore+0x15>
    nu = 4096;
    3a62:	bb 00 10 00 00       	mov    $0x1000,%ebx
  p = sbrk(nu * sizeof(Header));
    3a67:	8d 04 dd 00 00 00 00 	lea    0x0(,%ebx,8),%eax
    3a6e:	83 ec 0c             	sub    $0xc,%esp
    3a71:	50                   	push   %eax
    3a72:	e8 30 fd ff ff       	call   37a7 <sbrk>
  if(p == (char*)-1)
    3a77:	83 c4 10             	add    $0x10,%esp
    3a7a:	83 f8 ff             	cmp    $0xffffffff,%eax
    3a7d:	74 1c                	je     3a9b <morecore+0x49>
    return 0;
  hp = (Header*)p;
  hp->s.size = nu;
    3a7f:	89 58 04             	mov    %ebx,0x4(%eax)
  free((void*)(hp + 1));
    3a82:	83 c0 08             	add    $0x8,%eax
    3a85:	83 ec 0c             	sub    $0xc,%esp
    3a88:	50                   	push   %eax
    3a89:	e8 54 ff ff ff       	call   39e2 <free>
  return freep;
    3a8e:	a1 00 9b 00 00       	mov    0x9b00,%eax
    3a93:	83 c4 10             	add    $0x10,%esp
}
    3a96:	8b 5d fc             	mov    -0x4(%ebp),%ebx
    3a99:	c9                   	leave  
    3a9a:	c3                   	ret    
    return 0;
    3a9b:	b8 00 00 00 00       	mov    $0x0,%eax
    3aa0:	eb f4                	jmp    3a96 <morecore+0x44>
...
malloc(uint nbytes)
{
  ...
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    ...
    3aac:	8d 58 07             	lea    0x7(%eax),%ebx
    3aaf:	c1 eb 03             	shr    $0x3,%ebx
    3ab2:	83 c3 01             	add    $0x1,%ebx
  if((prevp = freep) == 0){
    3ab5:	8b 0d 00 9b 00 00    	mov    0x9b00,%ecx
    3abb:	85 c9                	test   %ecx,%ecx
    3abd:	74 04                	je     3ac3 <malloc+0x21>
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    3abf:	8b 01                	mov    (%ecx),%eax
    3ac1:	eb 4a                	jmp    3b0d <malloc+0x6b>
    base.s.ptr = freep = prevp = &base;
    3ac3:	c7 05 00 9b 00 00 04 	movl   $0x9b04,0x9b00
    3aca:	9b 00 00 
    3acd:	c7 05 04 9b 00 00 04 	movl   $0x9b04,0x9b04
    3ad4:	9b 00 00 
    base.s.size = 0;
    3ad7:	c7 05 08 9b 00 00 00 	movl   $0x0,0x9b08
    3ade:	00 00 00 
    base.s.ptr = freep = prevp = &base;
    3ae1:	b9 04 9b 00 00       	mov    $0x9b04,%ecx
    3ae6:	eb d7                	jmp    3abf <malloc+0x1d>
    if(p->s.size >= nunits){
      if(p->s.size == nunits)
    3ae8:	74 19                	je     3b03 <malloc+0x61>
        prevp->s.ptr = p->s.ptr;
      else {
        p->s.size -= nunits;
    3aea:	29 da                	sub    %ebx,%edx
    3aec:	89 50 04             	mov    %edx,0x4(%eax)
        p += p->s.size;
    3aef:	8d 04 d0             	lea    (%eax,%edx,8),%eax
        p->s.size = nunits;
    3af2:	89 58 04             	mov    %ebx,0x4(%eax)
      }
      freep = prevp;
    3af5:	89 0d 00 9b 00 00    	mov    %ecx,0x9b00
      return (void*)(p + 1);
    3afb:	83 c0 08             	add    $0x8,%eax
    }
    if(p == freep)
    ...
    3afe:	8b 5d fc             	mov    -0x4(%ebp),%ebx
    3b01:	c9                   	leave  
    3b02:	c3                   	ret    
        prevp->s.ptr = p->s.ptr;
    3b03:	8b 10                	mov    (%eax),%edx
    3b05:	89 11                	mov    %edx,(%ecx)
    3b07:	eb ec                	jmp    3af5 <malloc+0x53>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    3b09:	89 c1                	mov    %eax,%ecx
    3b0b:	8b 00                	mov    (%eax),%eax
    if(p->s.size >= nunits){
    3b0d:	8b 50 04             	mov    0x4(%eax),%edx
    3b10:	39 da                	cmp    %ebx,%edx
    3b12:	73 d4                	jae    3ae8 <malloc+0x46>
    if(p == freep)
    3b14:	39 05 00 9b 00 00    	cmp    %eax,0x9b00
    3b1a:	75 ed                	jne    3b09 <malloc+0x67>
      if((p = morecore(nunits)) == 0)
    3b1c:	89 d8                	mov    %ebx,%eax
    3b1e:	e8 2f ff ff ff       	call   3a52 <morecore>
    3b23:	85 c0                	test   %eax,%eax
    3b25:	75 e2                	jne    3b09 <malloc+0x67>
    3b27:	eb d5                	jmp    3afe <malloc+0x5c>
